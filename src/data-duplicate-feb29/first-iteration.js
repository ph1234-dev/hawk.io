export let data = [
    createData(1,'diarrhea',[
            ...
            'what foods you should avoid','ano ang mga pagkain na dapat iwasan kapag nagtatae','ngin i mga pegken a dili nenka maka u pedtaguro'
        ],[
            'how do you avoid diarrhea','paano maiiwasan ang pagtatae','panon i kapangabong sa kadtaguro'
        ],[
            'what are the correct ways to wash hands', 'ano angmga tamang pamamaraan ng paghuhugas ng kamay','ngin i mga ukit a pakasugat a kepenggagas sa lima'
        ],[
    ...
    createData(3,'diarrhea',
        [
            ...
            'how do you avoid diarrhea','paano mo maiiwasan ang pagtatae','[anun i kadzanggila nengka sa kadtaguro'
        ],[
    ...
    createData(4,'diarrhea',
        [
            ...
            'what ar ethe signs or symptoms to know if someone had diarrhea','anong mga palatandaan o di kutob para malaman ang isang tao ay mayron pagtatae','ngaini mga tanda tawa sipat o taw a aden salkanin e salat a kapedtagudo'
        ],[
            'what foods you should avoid when having diarrhea','ano ang mga pagkain na dapat iwasan kung may pagtatae','ngaini mga pegken a wagitb a inisapal amayka pagtagudo so tao'
        ],[
            ...
            'ask about its alternatives','itanong mo lang ukol sa kanyan mamamaraan','ipangingidsa nengka bo a kaped a makadgamit lon'
        ]
    ),
    createData(5,'diarrhea',
        [
            ...
            'what foods you should avoid when having diarrhea', ' anuano ang mga pagkain na dapat iwasan kapag nagtatae','ngin i mga pegken a nasisita a bagabugngan amengka pedtagudo'
        ],[
            'how do you avoid diarrhea','paano maiwasan ang pagtatae','panun i kaabugn sa pedtagudo'
        ],[
    ...
    createData(7,'diarrhea',
        [
          'how do you treat diarrhea','paano gagamutin ang diarrhea','panun i kagamot sa tagudo'
           ...
           'what is the typical dose or correct way of using the medicine bismuth subsalicylate','paano ang tmaang paggamit ng bismuth subsalicylate','paano i det a pakedan sa bismuth subsalicylate a gamot'
        ],[
    ...
    createData(8,'diarrhea',
        [
            ...
            'what is the alterantive of antimotility','ano ang pamalit sa antimotiity', 'ngin i makasambi sa antimotility'
        ]
    ),
    ...
    createData(10,'diarrhea',
        [
            'how do you treat diarrhea','paano mo gagamutin ag pagsusuka','panon i kagamot sa kapanguta'
        ],[
            ...
            'what food you should avoid when having diarrhea','anong pagkain ang dapat iwasan kapag ikaw ay may sakit na pagsusuka','ngin i mga pegken na det nengka pagsanggilan upama aden sakit nengka a kapangudo'
        ],[
            ...
            'what is the altenrative of antimotility','ano ang alternatibo para sa antimotility','ngin kaped a gamot lyu sa antimotility'
        ]
    ),
    createData(1,'influenza',[
            ...
            'what are the foods you should avoid if you have influenza','ano ano ang mg apagkain na dapat mong iwasan kapag may trangkaso','ngin e mga pegken a zanggilan amengka aden lumasa nengka'
        ],[
    ...
    createData(2,'influenza',
        [
            ...
            'what are the symptoms of infuenza','ano ang mga sintomas ng influenza','ngin i mga tanda sa aden influenza ta'
        ],[
            ...
            'guide me on th proper way of hand washing','turual mo ako tungo sa wastong paghuhugas ng kamay','pamanduy ako panun i usto a ukit u kagagas sa lima'
        ],[
            ...
            'what are the alternatives of lozenges','ano ang mga alternatibong gamot maliban sa lozenges','ngin mga gmaot a makasambi sa lozenges'
        ]
    ),
    createData(3,'influenza',
        [
            'how do you treat influenza','paano gamutin ang influenza o di kaya ay trnagkaso','panon e kagamot sa influenza o di na trangkaso'   
        ],[
            'what are the syins or symptoms to know if someone has influenza','ano ang mga palatandaan o d kayay mga sintomas para malaman ang isang tao ay mayrong influenza','ngaini mga tanda atawa sipat o taw e aden salkanin endo katawan e pedskait sa trangkaso'
        ],[
            ...
            'what is the tpical dose or correct way of using the medicines','ano ang kadalasan dose o di kaya tamang paraan sa paggamit ng medisina','ngaini katatapan a asadan atawa osto a mga okit a pagusal sa gamot'
        ],[
    ...
    createData(4,'influenza',[
            ...
            'what are the signs and symptoms to knwo if someone has influenza','ano ang sintomas na mayroon para malaman na may influenza','ngin i mga tanda o sipat na taw a belumasa'
        ],[
            'what foods you should avoid when having influenza','ano ang mg apagkain na dapat iwasan kapag may trangkaso','ngin i mga pegken a nasisita a kadsanggilan amengka belumasa'
        ],[
    ...
    createData(5,'influenza',
        [
            ...
            'what is the prescribed dose or correct way of using medicines','ano ang karaniwang dosis o tamang paraan ng paggamit ng gamot','ngeng i kalayaman a dosis atawa nasaguat a kapenggamit sa mga gamot'
        ],[ 
    ...
    createData(6,'influenza',
        [
            ...
            'what is the correct way of washing hte hands','ano ang tamang paraan ng paghugas ng mga kamay','ngin i nakasugat a ukit a kapamuwanaw sa lima' 
        ],[
    ...
    createData(7,'influenza',
        [
         'how do you treat influenza','paano mo gagamutin ang trangkaso','panon i kapenggamot nengka sa kaped trangkaso'   
            ...
            'what ar ethe signs or symptoms ','ano ano ang mga senyales o sintomas ng trangkaso','ngin i mga tanda sa tao a pedtrangkaso'
        ],[
            ...
            'what is the correct way of washing the hands','paano ang tamang paraan sa mag huhugas ng kamay','ngin i natanto a ukit na ka bamanaw sa lima'
        ],[
            ...
            'what are the other alternatives','ango ang iban pang alterntaibong gamot','ngin i ped a gapamilian a gamot'
        ]
    ),
    createData(8,'influenza',
        [
            ...
            'ask for directions on how to disinfect or boil water','mag tanong ng direksyon sa kung paano i disimpektahin o magpakulo ng tubig','idsa ka pan panun i kped awa sa maledsik o kaped tabel sa ig'
        ],[
    ...
    createData(9,'influenza',
        [
            ...
            'what foods you should avoid when aving influenza','ano anong mga pagkain ang dapat mong iwasan pag may trangkaso ka','ngin i mga pegken a dait a pananggilan amayka aden sepo ta'
        ],[
    ...
    createData(10,'influenza',
        [
            ...
            'what are the signs or symptoms to know if osmeone has influenza','ano ang mga isntomas kapag may trangkaso','ngin i mga tanda sa aden trangkaso'
        ],[
