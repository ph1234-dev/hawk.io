export let transFormedEnglishRules = [
    {
        "pattern": [
            "* sweet * diarrhea *",
    ...
    },
    {
        "pattern": [
            ...
            "Can eating taking unpeeled fruits be dangerous",
    ...
    },
    {
        "pattern": [
            ...
            "explain How raw meat be harmful worsen your diarrhea",
            "tell What are the dangers consequences of consuming eating raw meat",
            "tell What are the potential health caused hazards risks of eating uncooked undercooked raw meat",
            "tell What are the reasons to avoid for not consuming raw meat",
            "explain why What makes raw meat harmful to consume",
            "Why is it not recommended or important to cook raw meat thoroughly before eating"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            ...
            "Steps how to avoid getting diarrhea",
    ...
    },
    {
        "pattern": [
            ...
            "who that can be at risk when they get diarrhea",
            "tell who are those people can have problems when they get have diarrhea"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            ...
            "How should antimotility be taken properly",
            "tell give show What is the approved appropriate correct direction instructions to take antimotility dose",
            "tell give show What is the prescribed correct proper method way dose to take antimotility ",
            "tell give show What is the usual recommended way dosage to take antimotility ",
            "tell give show What is the suggested standard safe method way to take antimotility"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            ...
            "What are the uses indicated of antimotility",
    ...
    },
    {
        "pattern": [
            ...
            "Who is not recommended Which people should not take antimotility",
    ...
    },
    {
        "pattern": [
            ...
            "Any tips How should I take Loperamide?",
    ...
    },
    {
        "pattern": [
            "* bismuth * work *",
            "How does bismuth subsalicylate treat help reduce work",
            "What how is the way bismuth subsalicylate works treat",
            "What makes bismuth subsalicylate an effective treatment for",
    ...
    },
    {
        "pattern": [
            ...
            "when Who is it important void not recommended to take bismuth subsalicylate ",
            "Why should we avoid taking bismuth subsalicylate",
            "why bismuth subsalicylate should not be taken avoided",
            "tell me about When should why bismuth subsalicylate be avoided"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            "* effect * bismuth *",
            "Are there any adverse risks effects associated with bismuth subsalicylate",
            "Can you tell me about what the potential side effects of bismuth subsalicylate",
            "tell me the list of adverse reactions problems from taking bismuth subsalicylate"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            "* tips * bismuth *",
            "Can you give me special instructions advice for taking bismuth subsalicylate",
            "What are some tips to keep in mind when taking bismuth subsalicylate",
    ...
    },
    {
        "pattern": [
            ...
            "tell me how do you recognize identify the symptom sign of diarrhea"
        ],
        "response": [
