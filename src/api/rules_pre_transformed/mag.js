export let transFormedMaguindanaonRules = [
    {
        "pattern": [
            "* mamis * tagudo *",
    ...
    },
    {
        "pattern": [
            ...
            "ngin to sabap ka pedtagudo besen i taw"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            "* enggay * tagudo * ",
            "* makadtagudo * ",
            "panon i kadtagudo na taw",
            "enduken ngen to ka edtagudo i taw"
        ],
        "response": [
    ...
    {
        "pattern": [
            "* (kainom|ig) * (awa|gamot|kapya|tabang) *  tagudo * ",
            "panon nginto ka amayka minom edtandang su taw sa ig na egkakabagel sekanin sa kadtagudo nin",
            "panon nginto a to kakapaginom kainom bo sa ig i kagkabagel makagkapya na taw a pedtagudo",
            "panon Ngin a to ka nasisita su kapaginom sa ig amayka pedtagudo su taw"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            ...
            "ngin to ka pakagamot su kakan kainom sa zinc sa taw a pedtagudo",
            "panon duken a to ka su taw a pedtagudo na kagamutan na kakan kainom sa zinc",
            "panon ngin a to ka su kainom sa zinc na makagkapya sa taw a pedtagudo",
            "Ngin panon to ka nasisita su kainom kapaginom sa zinc amayka pedtagudo su taw"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            ...
            "panon kano besen i ka mangay sa doctor amayka pedtagudo i taw",
    ...
    },
    {
        "pattern": [
            ...
            "labit ka sa mapya a gamot mapakay a galbeken nu taw a pedtagudo",
            "ngin mapya mapaka enggulan na taw amayka pedtagudo sekanin",
            "ngin mga mapya mapakay a igamot sa taw a pedtagudo",
            "panon kagamot kapenggamot sa tagudo",
            "aden gamot pakagamot sa kapedtagudo"
        ],
        "response": [
    ...
    },
    {
        "pattern": [
            ...
            "panon i katabang kagamot sa taw a pedtagudo ugayd na pebpaugo",
            "aden lugo pedtagudo pan sekanin",
            "ngin i mapya galbeken a galbeken nu taw nakailay sa lugo a pedtagudo"
        ],
        "response": [
