let section4=[
    ...
    "enduken ka makadtagudo i kakan sa mamis a mga pegken",
    "eduken na to ka amayka di ka ged pakakakan na edtagudo ka",
    "nginto ka su parasite na pakadtagudo",
    "panon a to ka amayka makakan ka sa kagaw na edtagudo ka",
...
let section5=[
    ...
    "enduken ka pakadtabang su kapaginom sa zinc sa taw a bedtagudo",
    "kano i ka lu sa doktor amayka pedtagudo",
    "duken na mim edsamikel sa ig su taw a pedtagudo",
    "panon a to ka su kakan sa mapya na pakadtabang sa tayn san a pedtagudo",
    "duken ka nasisita i ka lu sa doktor",
...
let section6=[
    ...
    "enduken ka upisan i langon na unga bago pegkanen",
    ...
    "endaw ta mangay amayka pedtagudo ta",
    "panon i di kadtagudo na taw", 
...
let section11=[
    ...
    "pano besen i katabang na zinc sa pedtagudo",
    "enggay ka sa ngala na generic a loperamide",
    ...
    "endaw gagamit i loperamide",
    "panon besen i kanggalbek na loperamide",
    "kanu i di kakan nu taw sa antimotility",
    "ngin pan i mga ula ula sa kakan sa loperamide",
    "ngin pan i kaped a mapakay pegekanen lyu sa loperamide",
    "ngen i kaped a di mapya a manggula na taw amayka keman sa imodium",
    "labit ka kon sa ngen i mga balangan na antimotility",
    "ngen pan i makapakay a isambi sa loperamide"
]

let section12=[
    "mapakay a gamutan ko i tagudo ko sa walay bo?",
...
let section13=[
    ...
    "ngin i pangingatan nu taw a pedtagudo"
]

let section14=[
    "edaw ta midsa sa mga sipat na tagudo",
    "panon i kasipat nu taw na aden diarrhea nin",
    "panon i kataw nu taw sa ginagawa nin a pedtagudo den sekanin",
    "ngin i mapya ka kagamot sa tagudo",
    "amayka pedtagudo su taw na panon i kagamot sa to ba",
    "ngein i padsa na pedtagudo"
]

let section16=[
    //loop through later
    "panon i kagamot sa taw a pedtagudo",
...
let section20=[
    ...
    "mana so malipedes i tyan ko , ngen i galbeken ko samaya",
    "ngin i mapya a kanen nu taw a panguta",
    "nanguta i kaped ko , ngin i pakan ko sa lekanin",
    "ngin i mapya a i pakan sa taw a galangot",
    "enduken ka nsisita i katabel",
    "duken ka su taw na temabel sa ig",
    "ngin i mga ukit na ka linis sa ig"
]
