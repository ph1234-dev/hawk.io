...
let section16 = [
        `* (iwas| (hindi|huwag) * (kain|inom|gamit)) * antibiotics *`,
        `* antibiotics * (iwas| (hindi|huwag) * (kain|inom|gamit)) *`,
    ...
    encodeMemory([
        `* (iwas| (hindi|huwag) * (kain|inom|gamit)) * aspirin *`,
        `* aspirin * (iwas| (hindi|huwag) * (kain|inom|gamit)) *`,
    ...
    encodeMemory([
        ...
        `* iwas * (antibiotic|antibiotics|antivirals|antiviral)  *`,
    ],[
