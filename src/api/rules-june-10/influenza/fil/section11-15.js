...
let section11 = [
    ...
    encodeMemory([
        ...
        `* paano * (kainin|gamitin|inumin) * antihistamine *`,
        `* paano * antihistamine * (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas ) * antihistamine *`,
    ...
    encodeMemory([
        `* (side|masama) * effect * antihistamine * `,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * antihistamine *`,
        `* antihistamine * (price|presyo|gaano kamahal|kano) *`,
    ...
    encodeMemory([
        `* (dose|hakbang) * analgesics *`,
        `* paano * (kainin|gamitin|inumin) * analgesics *`,
        `* paano * analgesics * (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* analgesics? * (tulong|gamot|buti|galing) *`,
        `* (tulong|gamot|buti|galing) * analgesics *`,
        `* analgesics * (tulong|gamot|buti|galing) *`,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas) * analgesics *`,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * analgesics *`,
        `* analgesics * (price|presyo|gaano kamahal|kano) *`,
    ...
    encodeMemory([
        `* (dose|hakbang) * nsaid*`,
        `* (kainin|gamitin|inumin) * nsaid*`,
        `* nsaid * (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* nsaid * (tulong|gamot|buti|galing) *`,
        `* paano * gana * nsaid*`,
        `* paano * nsaid* gana * `,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas ) * nsaid*`,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * nsaid*`,
        `* nsaid* (price|presyo|gaano kamahal|kano) *`,
    ...
    encodeMemory([
        ...
        `* paano * (kainin|gamitin|inumin) * decongestant *`,
        `* paano * decongestant * (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* gana * decongestant *`,
        `* decongestants * (tulong|gamot|buti|galing) *`,
        `* decongestant * gana *`,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas) * decongestant *`,
    ...
    encodeMemory([
        `* (side|masama) * effect * decongestant * `,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * decongestant *`,
        `* decongestant * (price|presyo|gaano kamahal|kano) *`,
    ...
    encodeMemory([
        ...
        `* paano * expectorant * (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* gana * expectorant* `,
        `* expectorant* gana * `,
        `* expectorants? * (tulong|gamot|buti|galing) *`,
    ...
    encodeMemory([
        `*  ( (huwag|hindi) * (kain|inom|gamit) | iwas) * expectorant*`,
    ...
    encodeMemory([
        `* (side|masama) * effect * expectorant* `,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * expectorant*`,
        `* expectorant* (price|presyo|gaano kamahal|kano) *`,
    ...
    encodeMemory([
        `* (dose|hakbang) * antitussive  *`,
        `* (kainin|gamitin|inumin) * antitussive  *`,
    ...
    encodeMemory([
        `* antitussives? * (tulong|gamot|buti|galing) *`,
        `* antitussive * gana * `,
        `* gana * antitussive  *`,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas) * antitussive *`,
    ...
    encodeMemory([
        `* (side|masama) * effect * antitussive  *`,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * antitussive *`,
        `* antitussive * (price|presyo|gaano kamahal|kano) *`,
    ...
    encodeMemory([
        `* (dose|hakbang) * lozenge*`,
        `* (kainin|gamitin|inumin) * lozenge*`,
        `* lozenge* (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* lozenges * (tulong|gamot|buti|galing) *`,
        `* gana * lozenge*`,
        `* lozenge * gana *`,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas ) * lozenge*`,
    ...
    encodeMemory([
        `* (price|presyo|gaano kamahal|kano) * lozenge*`,
        `* lozenge* (price|presyo|gaano kamahal|kano) * `,
...
let section14 = [
    encodeMemory([
        `* (sino|saan) * tanong * (sintomas|senyales) * trangkaso *`,
        `* (sintomas|senyales) * trangkaso * (sino|saan) * tanong *`,
    ...
    encodeMemory([
        `* (senyales|sintomas) * trangkaso * `,
        `* (palatandaan|tanda) * trangkaso * `,
        `* masabi * trangkaso *`,
