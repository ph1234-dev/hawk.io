...
let section7 = [
    ...
    encodeMemory([
        ...
        `what foods can i eat when i have influenza`,
        `what foods i should take when i have influenza`,
...
let section8 = [
    // NOTE::: WE HAVE TO REMOVE THIS BECAUSE sweets will never be queries since it is also in influenza_foods_no_allowed
    // encodeMemory([
    ...
    //     `what foods i should not eat when i have influenza`,
    //     `what foods i should not take when i have influenza`,
    ...
    encodeMemory([
        ...
        `is it okay to eat or drink influenza_foods_not_allowed_caffeinated_drinks when feeling influenza`,
        `can i eat or drink when influenza_foods_not_allowed_caffeinated_drinks having influenza`,
        `can eating or drinking influenza_foods_not_allowed_caffeinated_drinks help treat influenza`,
        `is it okay to eat or drink influenza_foods_not_allowed_caffeinated_drinks when experiencing influenza`,
        `tell me if its okay to eat or drink influenza_foods_not_allowed_caffeinated_drinks when experiencing influenza`,
    ],[
    ...
    encodeMemory([
        ...
        //
        `is it okay to eat or drink influenza_foods_not_allowed_greasy_foods when feeling influenza`,
        `can i eat or drink when influenza_foods_not_allowed_greasy_foods having influenza`,
        `can eating or drinking influenza_foods_not_allowed_greasy_foods help treat influenza`,
        `is it okay to eat or drink influenza_foods_not_allowed_greasy_foods when experiencing influenza`,
        `tell me if its okay to eat or drink influenza_foods_not_allowed_greasy_foods when experiencing influenza`,
    ],[
        `
    ...
    encodeMemory([
        ...
        // 
        `is it okay to eat or drink influenza_foods_not_allowed_hard_grains when feeling influenza`,
        `can i eat or drink when influenza_foods_not_allowed_hard_grains having influenza`,
        `can eating or drinking influenza_foods_not_allowed_hard_grains help treat influenza`,
        `is it okay to eat or drink influenza_foods_not_allowed_hard_grains when experiencing influenza`,
        `tell me if its okay to eat or drink influenza_foods_not_allowed_hard_grains when experiencing influenza`,
    ],[
    ...
    encodeMemory([
        ...
        // 
        `is it okay to eat or drink influenza_foods_not_allowed_sugary_foods when feeling influenza`,
        `can i eat or drink when influenza_foods_not_allowed_sugary_foods having influenza`,
        `can eating or drinking influenza_foods_not_allowed_sugary_foods help treat influenza`,
        `is it okay to eat or drink influenza_foods_not_allowed_sugary_foods when experiencing influenza`,
        `tell me if its okay to eat or drink influenza_foods_not_allowed_sugary_foods when experiencing influenza`,
    ],[
