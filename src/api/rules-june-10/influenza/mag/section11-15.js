...
let section11 = [
    ...
    encodeMemory([
        ...
        `panon a to ka di mapakay a keman i taw sa analgesics i taw a aden influenza`,
...
let section14 = [
    encodeMemory([
        `*  idsa * (sign|symptoms|sintomas|senyales|padsa)  * influenza * `,
        `*(sign|symptoms|sintomas|senyales|padsa)  * influenza *  idsa *`,
    ...
    encodeMemory([
        `* (sign|symptoms|sintomas|senyales|padsa) * influenza * `,
        `* (kataw) * influenza *`,
