...
let section5 = [
    ...
    encodeMemory([
        ...
        `Upama ka adel dalo nengka na degka ka. Da ka blyu sa walay taman sa di maawa I kayaw nengka sa 24 oras, inom ka sa madael a ig, di ka blugata I lawas nengka, endu kan ka ebpyapya. Kagamutan ka bon upama ka makakan ka sa gamot a ka nga ton bun sa botika. `
    ],1),
    encodeMemory([
