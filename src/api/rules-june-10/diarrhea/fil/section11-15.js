...
let section11 = [
    ...
    encodeMemory([
        `*( (huwag|hindi) * (kain|inom|gamit) | iwas)  * antimotility *`,
    ...
    encodeMemory([
        `* bismuth subsalicylate * gana * `,
        `* gana *  bismuth subsalicylate * `,
    ...
    encodeMemory([
        `* ( (huwag|hindi) * (kain|inom|gamit) | iwas )  * bismuth subsalicylate *`,
...
let section12 = [
    ...
    encodeMemory([
        `* iba * acute diarrhea * chronic diarrhea * `,
        `* iba * chronic diarrhea * acute diarrhea * `,
...
let section14 = [
    ...
    encodeMemory([
        `* diarrhea * (senyales|sintomas) *`,
        `* (senyales|sintomas) * diarrhea * `,
        `* masabi * diarrhea * `,
