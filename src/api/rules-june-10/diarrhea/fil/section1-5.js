...
let section4 = [
    ...
    encodeMemory([
        `* (bakit|paano|kailan) * digestive * problem * diarrhea *`,
    ...
    encodeMemory([
        `* (trigger|dulot|resulta|bigay|dahilan) * diarrhea `,
        ...
        `anong Mga pagkain o inumin na maaaring magdulot ng diarrhea .`,
...
let section5 = [
    encodeMemory([
        `* hydrate  * (tulong|gamot|buti|galing) * diarrhea * `,
        `* tubig  * (tulong|gamot|buti|galing) * diarrhea *`,
    ...
    encodeMemory([
        `* zinc  * (tulong|gamot|buti|galing)  * diarrhea *`,
    ...
    encodeMemory([
        `* masustansya  * (tulong|gamot|buti|galing)  * diarrhea *`,
    ...
    encodeMemory([
        ...
        `* doctor * (tulong|gamot|buti|galing)  * diarrhea *`,
    ...
    encodeMemory([
        `* (tulong|gamot|buti|galing) * diarrhea * `,
    ...
    encodeMemory([
        `* (tulong|gamot|buti|galing|gawin) * dugo * (tae|diarrhea) *`,
    ...
    encodeMemory([
        `* (tulong|gamot|buti|galing|gawin) * diarrhea * lagnat * `,
        `* (tulong|gamot|buti|galing|gawin) * lagnat * diarrhea * `,
    ...
    encodeMemory([
        `* (tulong|gamot|buti|galing|gawin) * diarrhea * `,
