...
let section11 = [
    ...
    encodeMemory([
        ...
        `What are the reasons to avoid taking antimotility`,
        ...
        `Who should consult before taking antimotility`,
    ...
    encodeMemory([
        ...
        `explain or describe to me what are the side effects of antimotilities`
    ],[
    ...
    encodeMemory([
        ...
        `tell or give me an an advice on how to take antimotility`
    ],[
    ...
    encodeMemory([
        ...
        `* branded * bismuth subsalicylate * drugs *`,
    ...
    encodeMemory([
        ...
        `* bismuth subsalicylate * (take|use|eaten) *`,
        `* (dosing|direction) * bismuth subsalicylate *`,
    ...
    encodeMemory([
        ...
        `What are the reasons to avoid taking bismuth subsalicylate`,
    ...
    encodeMemory([
        `* side effect * bismuth subsalicylate *`,
        ...
        `tell me the list of side effects or problems from taking bismuth subsalicylate`
    ],[
    ...
    encodeMemory([
        ...
        `Can you recommend other products that can be used in place of bismuth subsalicylate to treat diarrhea?`,
...
let section13 = [
    encodeMemory([
        ...
        `What are the negative effects or problems of diarrhea on the body?`,  
        ...
        `Tell me about the possible when having diarrhea`,
        'Describe diarrhea',
        'What is diarrhea',
...
let section14 = [
    encodeMemory([
       ...
       // `Who can I talk to about the symptoms or signs of diarrhea?`,
        `tell me where can i ask about the signs and symptoms of diarrhea`,
        `tell where can i get a list of the signs and symptoms of diarrhea`
    ],[
    ...
    encodeMemory([
        ...
        `tell me the list of the signs and symptoms of diarrhea`,
        `describe to me the signs and symptoms of diarrhea`,
        `show me the list of the signs and symptoms of diarrhea`,
        `give me the list of the signs and symptoms of diarrhea`
    ],[
