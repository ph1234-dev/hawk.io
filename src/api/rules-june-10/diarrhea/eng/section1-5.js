...
let section4 = [
    ...
    // section 4
    encodeMemory([
        `* weak * immune * diarrhea *`,
        `How does the weak immune system result, contribute or lead to diarrhea?`,
        `What causes weak immune system to trigger diarrhea?`,
        `tell or explain why does weak immune system trigger diarrhea`,
    ],[
        `
    ...
    encodeMemory([
        `* sweet * diarrhea *`,
        `How do artificial sweet induce or contribute to  diarrhea?`,
        `How do sweet contribute to diarrhea?`,
        `How do sweet lead to diarrhea?`,
        `What are the effects of sweet on the digestive system that cause diarrhea?`,
        `What causes sweeteners to trigger diarrhea?`,
        `Why do sweet result in diarrhea?`,
        `tell or explain why does sweet trigger diarrhea`,
    ],[
        `
    ...
    encodeMemory([
        `* allergy * diarrhea *`,
        `How do allergies lead to diarrhea?`,
        `How does a allergy contribute to diarrhea?`,
        `How does the immune response to allergens cause diarrhea?`,
        `What are the effects of allergies on the digestive system that cause diarrhea?`,
        `What causes allergies to trigger diarrhea?`,
        `What is the role of allergies in the development of diarrhea?`,
        `Why does a allergy result in diarrhea?`,
        `tell or explain why does allergy trigger diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `tell or explain why does malnutrition trigger diarrhea`,
    ],[
    ...
    encodeMemory([
        `* drug * trigger *  diarrhea * `,
        `How do certain drug lead to diarrhea?`,
        `How do some drug disrupt the digestive system to cause diarrhea?`,
        `What are the contributing factors to some drugs causing diarrhea?`,
        `What causes some drugs to trigger diarrhea?`,
        `Why is diarrhea can be a side effect of some drug?`,
        `tell or explain why does some drugs trigger diarrhea`,
    ],[
    ...
    encodeMemory([
        `* parasite * diarrhea *`,
        `How do parasites trigger diarrhea?`,
        ...
        `tell or explain why does parasites trigger diarrhea`,
    ...
    encodeMemory([
        ...
        `tell or explain why does bacteria cause diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `tell or explain why does virus cause diarrhea`,
    ...
    encodeMemory([
        `* digestive problem * trigger * diarrhea * `,
...
let section5 = [
    encodeMemory([
        ...
        `How does replenishing fluids with water help to alleviate diarrhea?`,
    ...
    encodeMemory([
        ...
        `tell or explain why does zinc help with diarrhea`,
    ],[
        `
    ...
    encodeMemory([
        `* (good|healthy) * food  * treat * diarrhea *`,
        `How does a healthy diet help to prevent diarrhea from occurring?`,
        `How does eating a healthy foods or diet help to treat diarrhea?`,
        `What are some examples of healthy foods to eat during diarrhea?`,
        `What are the benefits of eating a healthy foods when dealing with diarrhea?`,
        ...
        `tell or explain why does eating healhy foods treat diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `At what stage of diarrhea or point should I see or consult a doctor?`,
        `How can a doctor help me to treat my diarrhea?`,
        `How do I know if I need to see or consult a doctor for my diarrhea?`,
        `What are the benefits of consulting a doctor for diarrhea treatment?`,
        `When does diarrhea require medical attention?`,,
        `When is it necessary or appropriate to consult for diarrhea?`,
        `When should I consult a doctor when having diarrhea?`,
        `when important consult doctor diarrhea`,
    ...
    encodeMemory([
        ...
        `What drugs are recommended for treating diarrhea?`,
        `What drugs can be used to treat diarrhea?`,
        `What medicines are there for diarrhea?`,
        `What remedies can I use to treat diarrhea?`,
        `What steps should I take to alleviate or treat diarrhea?`,
    ],[
    ...
    encodeMemory([
        `* buy * (zinc|bismuth|antimotility) oral rehydration (solutions?|salts?) *`,
        `* buy * diarrhea * drugs *`,
        `* buy * drugs *`,
        `* buy * drugs *`,
        `Where can I purchase medication or zinc,bismuth,antimotility, oral rehydration solution salt for diarrhea?`,
        `Are diarrhea drugs or zinc,antimotilities,bismuth, oral rehydration solutions salts available or sold over the counter?`,
        ...
        `Which pharmacies sell zinc,bismuth,antimotilities, antimotility, oral rehydration solution salt`,
    ],[
    ...
    encodeMemory([
        ...
        `How should I manage if I have a fever and diarrhea at the same time?`,
        ...
        `If I'm experiencing both fever and diarrhea`,
        `If I'm suffering from fever and diarrhea`,
        ...
        `What's the treatment if I have a fever while experiencing diarrhea?`,
    ],[
