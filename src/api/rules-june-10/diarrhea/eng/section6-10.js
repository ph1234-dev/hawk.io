...
let section6 = [
    encodeMemory([
        ...
        `why should i have to remove the skin of fruits before eating them`,
        `why remove skin of fruits before cooking or taking`,
        `why remove skins of fruits before cook or eating`
    ],[
...
let section7 = [
    ...
    encodeMemory([
        `* drink * diarrhea_foods_allowed * diarrhea *`,
        `* buy * diarrhea_foods_allowed * diarrhea *`,
        `* take * diarrhea_foods_allowed * diarrhea *`,
        `* why * eat * diarrhea_foods_allowed * diarrhea *`,
    ...
    encodeMemory([
        ...
        `what foods should take when i have diarrhea`,
        ...
        `tell me about the foods that can be eaten when having diarrhea`,
        'what foods can i eat take and drink when having diarrhea',
        'tell me what foods i can eat or take when feeling diarrhea',
        'show me the list of foods what foods that i can eat , drink or take when feeling or having diarrhea',
        'get me the list of foods that i can eat, drink take when having diarrhea'
    ],[
        `You can eat arrozcaldo, bananas, broth, chicken, chicken soup, congee, electrolyte drinks, oatmeal, peanut butter ,potatoes, rice, soup, sports drinks, toasts, water, yogurt, rice soup (am) , and buko juice. These are only some of the foods you may taken when having diarrhea.`
    ],4),
]
...
let section8 = [
    ...
    encodeMemory([
        `* diarrhea_foods_not_allowed_bad_hydration * not * (take|buy|eat) * diarrhea *`,
        `* diarrhea_foods_not_allowed_bad_hydration * avoid * diarrhea *`,
        `* avoid * diarrhea_foods_not_allowed_bad_hydration * diarrhea *`,
        `*not * (take|buy|eat)* diarrhea_foods_not_allowed_bad_hydration * diarrhea *`,
        `what foods i should not eat when i have diarrhea`,
        `what foods i should not take when i have diarrhea`,
        `What are the risks of eating consuming diarrhea_foods_not_allowed_bad_hydration when experiencing diarrhea?`,  
        ...
        //
        `is it okay to eat or drink diarrhea_foods_not_allowed_bad_hydration when feeling diarrhea`,
        `can i eat or drink when diarrhea_foods_not_allowed_bad_hydration having diarrhea`,
        `can eating or drinking diarrhea_foods_not_allowed_bad_hydration help treat diarrhea`,
        `is it okay to eat or drink diarrhea_foods_not_allowed_bad_hydration when experiencing diarrhea`,
        `tell me if its okay to eat or drink diarrhea_foods_not_allowed_bad_hydration when experiencing diarrhea`,
    ],[
    ...
    encodeMemory([
        `* diarrhea_foods_not_allowed_produces_gas * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* diarrhea_foods_not_allowed_produces_gas * avoid * diarrhea *`,
        `* (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_produces_gas * diarrhea *`,
        ...
        //
        `is it okay to eat or drink diarrhea_foods_not_allowed_produces_gas when feeling diarrhea`,
        `can i eat or drink when diarrhea_foods_not_allowed_produces_gas having diarrhea`,
        `can eating or drinking diarrhea_foods_not_allowed_produces_gas help treat diarrhea`,
        `is it okay to eat or drink diarrhea_foods_not_allowed_produces_gas when experiencing diarrhea`,
        `tell me if its okay to eat or drink diarrhea_foods_not_allowed_produces_gas when experiencing diarrhea`, 
    ],[
    ...
    encodeMemory([
        `* diarrhea_foods_not_allowed_contains_lactose * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* diarrhea_foods_not_allowed_contains_lactose * avoid * diarrhea *`,
        `* (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_contains_lactose * diarrhea *`,
        `* avoid * diarrhea_foods_not_allowed_contains_lactose * diarrhea *`,
        ...
        //
        `is it okay to eat or drink diarrhea_foods_not_allowed_contains_lactose when feeling diarrhea`,
        `can i eat or drink when diarrhea_foods_not_allowed_contains_lactose having diarrhea`,
        `can eating or drinking diarrhea_foods_not_allowed_contains_lactose help treat diarrhea`,
        `is it okay to eat or drink diarrhea_foods_not_allowed_contains_lactose when experiencing diarrhea`,
        `tell me if its okay to eat or drink diarrhea_foods_not_allowed_contains_lactose when experiencing diarrhea`, 
    ],[
    ...
    encodeMemory([
        `* diarrhea_foods_not_allowed_contains_fructose * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* diarrhea_foods_not_allowed_contains_fructose * avoid * diarrhea *`,
        `* (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_contains_fructose * diarrhea *`,
        ...
        //
        `is it okay to eat or drink diarrhea_foods_not_allowed_contains_fructose when feeling diarrhea`,
        `can i eat or drink when diarrhea_foods_not_allowed_contains_fructose having diarrhea`,
        `can eating or drinking diarrhea_foods_not_allowed_contains_fructose help treat diarrhea`,
        `is it okay to eat or drink diarrhea_foods_not_allowed_contains_fructose when experiencing diarrhea`,
        `tell me if its okay to eat or drink diarrhea_foods_not_allowed_contains_fructose when experiencing diarrhea`,
    ],[
    ...
    encodeMemory([
        `* diarrhea_foods_not_allowed_irritate_stomach * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* diarrhea_foods_not_allowed_irritate_stomach * avoid * diarrhea *`,
        `* (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_irritate_stomach * diarrhea *`,
        `* avoid * diarrhea_foods_not_allowed_irritate_stomach * diarrhea *`,
        ...
        //
        `is it okay to eat or drink diarrhea_foods_not_allowed_irritate_stomach when feeling diarrhea`,
        `can i eat or drink when diarrhea_foods_not_allowed_irritate_stomach having diarrhea`,
        `can eating or drinking diarrhea_foods_not_allowed_irritate_stomach help treat diarrhea`,
        `is it okay to eat or drink diarrhea_foods_not_allowed_irritate_stomach when experiencing diarrhea`,
        `tell me if its okay to eat or drink diarrhea_foods_not_allowed_irritate_stomach when experiencing diarrhea`,
    ],[
    ...
    encodeMemory([
        `* diarrhea_foods_not_allowed_oily * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* diarrhea_foods_not_allowed_oily * avoid * diarrhea *`,
        `* (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_oily * diarrhea *`,
        `* avoid * diarrhea_foods_not_allowed_oily * diarrhea *`,
        ...
        //
        `is it okay to eat or drink diarrhea_foods_not_allowed_oily when feeling diarrhea`,
        `can i eat or drink when diarrhea_foods_not_allowed_oily having diarrhea`,
        `can eating or drinking diarrhea_foods_not_allowed_oily help treat diarrhea`,
        `is it okay to eat or drink diarrhea_foods_not_allowed_oily when experiencing diarrhea`,
        `tell me if its okay to eat or drink diarrhea_foods_not_allowed_oily when experiencing diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `* foods * not * eaten * diarrhea *`,
        `* foods * not * taken * diarrhea *`,
        `* foods * avoided * diarrhea *`,
        `* foods * not * eaten* diarrhea *`,
        `* foods * not * taken * diarrhea *`,
        `* avoid * foods * diarrhea *`,
        `* diarrhea * not * eaten * foods *`,
        `* diarrhea * foods * not * eaten *`,
        `* (give|buy|eat) * (diarrhea_foods_not_allowed_bad_hydration
        ...
        `What foods to avoid when having diarrhea?`,
    ],[
        `
...
let section10 = [
    ...
    encodeMemory([
        ...
        `Who is more likely to experience severe diarrhea?`,
        ...
        `Who may need to take additional measures to manage their diarrhea?`,
