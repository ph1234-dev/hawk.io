...
export const substitutionsGeneric = [
    ...
    encodeSubstitution('bismuth',['subsalicy(.*)']),
    ...
    encodeSubstitution('cold',['colds', 'sepu', 'sipon', '(i|e)?ng(u|o)g(en)?']),
    ...
    encodeSubstitution('form',['anyo(.*)','antas','hitsura']),
    ...
    encodeSubstitution('exist',['mayroong', 'meron', '(m|n|p)agka(ka)?roon']),
    encodeSubstitution('exist',['(.*)exist(.*)']),
    encodeSubstitution('exist',['aden']),
    ...
    encodeSubstitution('allow',['(m|n|k|g)apakay(.*)']),
    encodeSubstitution('allow',['pu?wede(ng)?', 'maaari(ng)?']),
    encodeSubstitution('allow',['approved']),
    ...
    encodeSubstitution('tip',['advi(s|c)(.*)']),
    ...
    encodeSubstitution('touch',['(.*)contact(.*)', '((n|p|m)ag)?(o|u)bayn?','mobay']),
