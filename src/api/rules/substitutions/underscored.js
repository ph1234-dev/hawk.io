...
export const substitutionsUnderscored = [
    ...
    // encodeSubstitution('diarrhea_drugs',['antimotilit(ies|y)']),  z
    encodeSubstitution('diarrhea_foods_allowed',['Arroz caldo', 'bananas?', 'broths?', 'chickens?', 'congee?', 'electrolyte drinks?', 'fruit juice', 'oatmeals?', 'peanut butter?', 'potato(es)?', 'rice', 'soup?', 'sports drinks?', 'toasts?', 'yogurt']),
    encodeSubstitution('diarrhea_foods_allowed',['sabaw', 'manok', 'lugaw', 'bigas']),
    encodeSubstitution('diarrhea_foods_allowed',['sinabawan', 'manuk', 'b(e|i)n(u|o)b(u|o)g', 'emay', `saging`,`patatas`]),
    // addition for maguindanaton terms
    ...
    encodeSubstitution('diarrhea_foods_not_allowed_oily',['prito(ng)?', 'pinirito', 'baboy', 'fat(s|ty)?']),
    encodeSubstitution('diarrhea_foods_not_allowed_oily',['(na|ma)?s(e|i)n(e|i)ndag', '(.*)nendag', 'kembot', '(.*)?ma(ma)?ntika(.*)?']),
    ...
    encodeSubstitution('influenza_foods_allowed',['broccoli', 'broths?', 'chicken soups?', 'fruits', 'garlics?', 'gingers?', 'herbal teas with honey', 'juices?', 'leafy greens?', 'oatmeals?', 'soups?', 'spices?', 'yogurts?', 'oranges?', 'peppers?', 'citrus(es)?', 'berr(y|ies)', 'cabbages?', 'spinach']),
    ...
    encodeSubstitution('influenza_foods_not_allowed_caffeinated_drinks',['coffee', 'espresso']),
    encodeSubstitution('influenza_foods_not_allowed_greasy_foods',['fr(y|ies|ied|ying)', 'burgers?', 'hotdogs?', 'bacons?', 'sausages?', 'dogs?']),
    encodeSubstitution('influenza_foods_not_allowed_greasy_foods',['prito(ng)?', 'pinirito', 'baboy', 'fat(s|ty)?']),
    encodeSubstitution('influenza_foods_not_allowed_greasy_foods',['(na|ma)?s(e|i)n(e|i)ndag', '(.*)nendag', 'kembot', '(.*)?ma(ma)?ntika(.*)?']),
    encodeSubstitution('influenza_foods_not_allowed_hard_grains',['quinoa', 'rice', '(corn|maize)', 'trigo', 'buckwheat', 'bibingka']),
    encodeSubstitution('influenza_foods_not_allowed_sugary_foods',['leche flan', 'halo halo', 'turon', 'halaya', 'pastillas', 'puto','cake','pie']),
