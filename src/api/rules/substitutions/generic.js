...
export const substitutionsGeneric = [
    ...
    encodeSubstitution('allergy',['allerg(.*)','alerhiya']),
    ...
    encodeSubstitution('alternative',['alter(.*)','alternati(.*)', 'substitut(.*)', '(.*)pilian(.*)']),
    encodeSubstitution('alternative',['else','(an)?others?','(be|a)sides?','maliban']),
    encodeSubstitution('alternative',['herb(.*)','halamang?']),
    encodeSubstitution('alternative',['makasambi','isambi','sambi','ganti']),
    encodeSubstitution('alternative',['iba(ng)?','(g|k)apamili(y)?an','kaped','kaper','kapora','liw','(.*)sambi','ped','kapad','salakaw','makaganti','(.*)ganti','ganti','pamalit','isambi']),
    ...
    encodeSubstitution('avoid',['(.*)panangg?ill?an(.*)','pananggillan']),
    encodeSubstitution('avoid',['ab(u|o)ng(an)?','bagabungan','kaab(u|o)ng(an)?','kapangab(o|u)ng']),
    encodeSubstitution('avoid',['pangabungan','kazangg?ila','kadsanggilan?','kadzangg?ila','edsangg?ilan','kapanangg?ila','pagsanggilan','zangg?ilan','pengsanggilan','pedsanggilan','kasanggilan']),
    ...
    encodeSubstitution('boil',['kapadseb(o|u)','kapapedseb(o|u)','pakuluan','(.*)pakulo']),
    encodeSubstitution('boil',['(.*)boil(.*)', '(.*)kul(o|u(in|han)g?)','pakulohin','sebu','magpainit']),
    ...
    encodeSubstitution('clean',['(.*)clean(.*)', '(.*)saniti(.*)', '(.*)disinfect(.*)', 'wash(.*)','(.*)gagas(.*)']),
    encodeSubstitution('clean',['(.*)limp(i|y)(o|u)(.*)', '(.*)l(um)?inis(.*)', '(.*)h(um|in)?ugas(.*)']),
    encodeSubstitution('clean',['(.*)hugas(.*)','(.*)kaugas(.*)','ugas','kalimpiyo']),
    encodeSubstitution('clean',['disimpektahin','disinpek','kagagaas','(ka)?bamanaw','kabamuanaw','kabamuwanaw','kapamanaw','kebamanaw','kapamuranaw','kapamuwanaw']),
    ...
    encodeSubstitution('cold',['colds', '(.*)se?p(o|u)', '(.*)sipon', '(i|e)?ng(u|o)g(en)?','pedsip(u|o)','sep(o|u)']),
    ...
    encodeSubstitution('correct',['da(i|y)t','det','asadan','h?ust(u|o)'],'(p|n)akasugat','nasasangan','natanto','osto','korek','(naka|paka)?tidt(u|o)'),
    encodeSubstitution('correct',['kanggulalalan','katatapan','nakatidt(o|u)','pakatidt(o|u)','pakasugat','osto','tidt(o|u)','nasasangan']),
    ...
    encodeSubstitution('decongestant',['decongestants?', 'sudafed', 'pseudoephedrine','decolgen']),
    ...
    encodeSubstitution('diarrhea',['(.*)diarrhea(.*)','(.*)tae?tae','(.*)tae','(.*)tag(u|o)d(o|u)','kapedtaguru']),
    encodeSubstitution('diarrhea',['(.*)lbm','bowel','dayariya','(p|b)edtagud(u|o)']),
    encodeSubstitution('diarrhea',['(ka)?bagu(d|r)o','kabagu(d|r)o','kadtagu(d|r)o','kapagu(d|r)o','kapagu(d|r)o','pedtagu(d|r)o','tagu(d|r)o','kapangu(d|r)o','kapedtagu(d|r)o']),
    ...
    encodeSubstitution('eat',['consum(.*)','konsumo','kapegkan','pangingkanen']),
    ...
    encodeSubstitution('food',['pangeng?ken']),
    ...
    encodeSubstitution('how',['(.*)paa?no(.*)?', 'pan(u|o)n?','panun','panon']),
    ...
    encodeSubstitution('influenza',['(.*)lumasa']),
    ...
    encodeSubstitution('method',['okit','pagusal','kapagusal','pamaraan']),
    ...
    encodeSubstitution('not',['hindi','di','dili', 'kundi', '(d(e|i))?kena']),
    encodeSubstitution('not',['huwag', 'wag','ayaw','inisapal']),
    ...
    encodeSubstitution('sick',['kadalu','dinadamdam','kapendalu']),
    ...
    encodeSubstitution('symptom',['symptoms?', 'sintomas','sepat','sipat']),
    ...
    encodeSubstitution('tell',['pamanduy']),
    ...
    encodeSubstitution('treat',['(.*)manag(.*)']),
    encodeSubstitution('treat',['(.*)control(.*)','kapenggamot']),
    encodeSubstitution('try',['tr(ied|ying|ies)','(.*)s(um|in)?ub(o|u)k(.*)']),
    encodeSubstitution('use',['((n|m|g)a)?usal(.*)','kausal']),
    encodeSubstitution('use',['(.*)g(um|in|em)?am(e|i)t(.*)','kapenggamit','paggamit']),
    encodeSubstitution('use',['usage','pamamagitan']),
    encodeSubstitution('use',['use(.*)','using', 'util(.*)']),
    ...
    encodeSubstitution('what',['ngaini?']),
