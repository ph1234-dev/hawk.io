...
let section6 = [
    ...
    encodeMemory([
        ...
        `tell me why do you avoid touching your eyes`,
        `tell me why do you avoid touching your nose`,
        `tell me why do you avoid touching your mouth`,
    ],[
...
let section7 = [
    ...
    encodeMemory([
        ...
        `tell me the foods that i can eat when having influenza`,
        `what are the foods that i can take when having influenza`,
...
let section8 = [
    ...
    encodeMemory([
        ...
        `Why is it important to avoid sweet foods when you have the flu?`,
    ...
    encodeMemory([
        ...
        `I'm not sure which foods not eat when I have influenza`,
        ...
        `Which foods should I  remove from my diet when I have the flu?`,
        `tell me what foods i should not avoid when having flu`,
        `get me the list of foods that i cannot take when having influenza`,
        `show me the list of foods that i cannot take when having influenza`,
        `get me the list of foods that i should avoid when having flu`,
        `tell me the list of foods that i should not eat or avoid when having influenza`,
    ],[
