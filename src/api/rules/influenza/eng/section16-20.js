...
let section16 = [
    ...
    encodeMemory([
        ...
        "What are the reasons for avoiding aspirin?",
        "Why is it not recommended to take aspirin?",
        "What are the dangers of taking aspirin?",
        "Why should I not take aspirin?",
        "What are the potential harms of taking aspirin?",
        "What are the possible negative effects of aspirin?",
        "What are the contraindications for taking aspirin?",
        "What are the downsides of taking aspirin?"
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        "What are the potential side effects of analgesics?",
        ...
        "What are some alternatives to analgesics?",
    ...
    encodeMemory([
        ...
        "What are the alternatives to antihistamines?",
        "What are the dangers of taking antihistamines?",
        "What are the negative effects of antihistamines?",
        "What are the possible risks associated with antihistamines?",
        "What are the precautions to take before using antihistamines?"
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        "What are the dangers of taking decongestants?",
        ...
        "What makes decongestants unsafe to use?","What are the possible negative effects of decongestants?",
        "Why are decongestants not suitable for everyone?",
        "What are the disadvantages of using decongestants?"
        //chatgpt end
    ],[
...
let section20 = [
    ...
    encodeMemory([
        ...
        `When trying to control nausea, you can do the following:
...
let section21 = [
    ...
    encodeMemory([
        ...
        "What are some natural ways to treat a sore throat?",  
        "How can I ease the pain of a sore throat?",  
        "What are some home remedies for a sore throat?",  
        "What are the best ways to treat a sore throat?",  
        "What are some over-the-counter treatments for a sore throat?"
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        //chatgpt start
        "What are some ways to decrease body stiffness?",
        "What can I do to ease body stiffness?",
        "How can I alleviate body stiffness?",
        "What are some ways to relieve body stiffness?",
        "What are some techniques to lessen body stiffness?",
        "What are some strategies for reducing body stiffness?",
        "How can I loosen up my body stiffness?",
        "What exercises can help reduce body stiffness?",
        "What stretches can I do to alleviate body stiffness?",
        "What are some home remedies for reducing body stiffness?"
        //chatgpt end
    ],[
