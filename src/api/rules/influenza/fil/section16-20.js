...
let section16 = [
    encodeMemory([
        "* bakit * (iwas| (hindi|huwag)  * (kain|inom|gamit))  * gamot_sa_influenza *"
    ],[
        ""
    ]),
    encodeMemory([
        "* bakit * (iwas| (hindi|huwag)  * (kain|inom|gamit))  * gamot_sa_influenza *",
        "* bakit * gamot_sa_influenza * (iwas| (hindi|huwag)  * (kain|inom|gamit))  *"
    ],[
        ""
    ]),
    encodeMemory([
        "* bakit * (iwas| (hindi|huwag)  * (kain|inom|gamit))  * antibiotics * ",
        "* bakit * antiobitics * (iwas| (hindi|huwag)  * (kain|inom|gamit))  *"
    ],[
    ...
    encodeMemory([
        ...
        "* bakit * decongenstants * (iwas| (hindi|huwag)  * (kain|inom|gamit))  * influenza *"
    ],[
    ...
    encodeMemory([
        ...
        "* sino * (huwag|hind)* (gumamit|kain|inom) * * gamot_sa_influenza *",
        "* sino * iwas * on_the_counter _drug_ gamot_sa_influenza *",
