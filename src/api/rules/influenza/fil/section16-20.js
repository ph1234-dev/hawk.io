...
let section16 = [
    ...
    encodeMemory([
        ...
        //chatgpt start
        "Ano ang dahilan kung bakit kailangan umiwas sa mga analgesics?",
        "Bakit hindi mabuti ang sobrang pag-inom ng analgesics?",
        "May mga side effects ba ang analgesics?",
        "Ano ang masamang epekto ng sobrang paggamit ng analgesics?",
        "Maaaring magdulot ba ng pinsala ang labis na pag-inom ng analgesics?",
        "Ano ang mga komplikasyon na maaring idulot ng sobrang pag-inom ng analgesics?",
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        //chatgpt start
        "Ano ang masamang epekto ng mga decongestants?",
        "Bakit hindi maganda gamitin ang mga decongestants?",
        "Paano nakakasama sa kalusugan ang paggamit ng decongestants?",
        "Bakit hindi inirerekumenda ang decongestants para sa ilang tao?",
        "May mga side effects ba ang mga decongestants?",
        "Paano nakakaapekto sa katawan ang labis na paggamit ng decongestants?",
        "Ano ang mga rason kung bakit dapat iwasan ang mga decongestants?",
        "Bakit hindi dapat basta-basta gamitin ang mga decongestants?",
        "Ano ang mga babala sa paggamit ng mga decongestants?"
        //chatgpt end
    ],[
...
let section20 = [
    ...
    encodeMemory([
        ...
        //chatgpt start
        "Ano ang mga paraan para maiwasan ang mga germs?",
        "Saan pwedeng makakuha ng tips para maiwasan ang mga germs?",
        "Paano mapapababa ang posibilidad na mahawa ng mga germs?",
        "Ano ang mga dapat gawin upang maiwasan ang pagkalat ng mga germs sa opisina?",
        "Ano ang mga dapat gawin para maiwasan ang pagkakaroon ng germs sa mga damit?",
        "Paano maiiwasan ang pagkalat ng germs sa mga pampublikong lugar?",
        "Ano ang mga dapat gawin upang maiwasan ang pagkalat ng germs sa loob ng sasakyan?",
        "Paano maiiwasan ang pagkakaroon ng germs sa mga personal na gamit?"
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        "May mga doktor ba na mas nakakatulong sa baradong ilong kaysa sa iba?",
    ...
    encodeMemory([
        ...
        "Anong mga activities ang pwedeng gawin para maibsan ang nausea?",
