...
let section11 = [
    ...
    encodeMemory([
        ...
        `Ano-ano ang mga pangalan ng generic na antihistamines?`,
        ...
        `ano ang generic na antihistamines`
    ], [
    ...
    encodeMemory([
        ...
        `ano ang branded na antihistamines`
    ], [
    ...
    encodeMemory([
        ...
        `* paano * (gamitin) * antihistamine *`,
        `* paano * (inumin) * antihistamine *`,
        `* paano * (kainin) * antihistamine *`,
        `* paano * antihistamine * (gamitin) *`,
        `* paano * antihistamine * (inumin) *`,
        `* paano * antihistamine * (kainin) *`,
        ...
        `ano ang dose ng antihistamines`,
        `paano ang dose ng antihistamines,`
    ], [
    ...
    encodeMemory([
        ...
        `saan ginagamit ang antihistamines`,
        `paano ginagamit ang antihistamines`,
    ], [
       `
    ...
    encodeMemory([
        ...
        `bakit hindi kainin ang antihistamines`,
        `bakit hindi uminom ng antihistamines`,
    ], [
    ...
    encodeMemory([
        ...
        `ano ang side effect ng antihistamines`,
        `ano ang hindi magandang epekto ng antihistamines`,
    ], [
    ...
    encodeMemory([
        ...
        `sabihin mo sakin ano ang mga porma ng antihistamines`,
    ], [
    ...
    encodeMemory([
        ...
        `Ano ang ibang gamot na pwedeng gamitin maliban at kaysa sa antihistamines?`,
        ...
        `May mga natural na pampawala ba ng pangangati dahil sa allergies antihistamines?`,
        `ano ang alternatibo sa antihistamines`,
        `paano ang alternatibo sa antihistamines`,
    ], [
    ...
    encodeMemory([
        `* (hakbang) * analgesics *`,
        `* (dose) * analgesics *`,
        `* paano * (inumin) * analgesics *`,
        `* paano * (gamitin) * analgesics *`,
        `* paano * (kainin) * analgesics *`,
        `* paano * analgesics * (inumin) *`,
        `* paano * analgesics * (kainin) *`,
        `* paano * analgesics * (gamitin) *`,
        ...
        `Paano dapat gamitin ang mga analgesics sa tamang dosis?`,
    ...
    encodeMemory([
        ...
        `saan ginagamit ang analgesics`,
        `paano ginagamit ang analgesics`,
    ], [
        `
    ...
    encodeMemory([
        ...
        `bakit hindi kainin ang analgesics`,
        `bakit hindi uminom ng analgesics`,  
    ], [
    ...
    encodeMemory([
        ...
        `ano ang side effect ng analgesics`,
        `ano ang hindi magandang epekto ng analgesics`,
    ], [
    ...
    encodeMemory([
        ...
        `sabihin mo sakin ano ang mga porma ng analgesics`
    ], [
    ...
    encodeMemory([
        ...
        `ano ang alternatibo sa analgesics`,
    ...
    encodeMemory([
        ...
        `ano ang branded na decongestants`
    ], [
    ...
    encodeMemory([
        ...
        `* paano * (gamitin) * decongestant *`,
        `* paano * (inumin) * decongestant *`,
        `* paano * (kainin) * decongestant *`,
        `* paano * decongestant * (gamitin) *`,
        `* paano * decongestant * (kainin) *`,
        `* paano * decongestant * (inumin) *`,
    ...
    encodeMemory([
        ...
        `paano nagpapagaling ang decongestants`
    ], [
    ...
    encodeMemory([
        ...
        `bakit hindi kainin ang decongestants`,
        `bakit hindi uminom ng decongestants`,  
    ], [
    ...
    encodeMemory([
        ...
        `ano ang side effect ng decongestants`,
        `ano ang hindi magandang epekto ng decongestants`,
    ], [
    ...
    encodeMemory([
        ...
        `sabihin mo sakin ano ang mga porma ng decongestant`
    ], [
    ...
    encodeMemory([
        ...
        `ano ang alternatibo sa decongestants`,
        `paano ang alternatibo sa decongestants`,
    ], [
    ...
    encodeMemory([
        ...
        `Ilarawan ang mga generic na expectorants na nag  papabawas ng plema.`, 
    ...
    encodeMemory([
        ...
        `* paano * (kainin|gamitin|inumin) * expectorant*`,
        `* paano * (kainin|gamitin|inumin) * expectorant*`,
        `* paano * expectorant * (gamitin) *`,
        `* paano * expectorant * (kainin) *`,
        `* paano * expectorant * (inumin) *`,
    ...
    encodeMemory([
        ...
        `saan ginagamit ang expectorants`,
        `paano ginagamit ang expectorants`,
    ], [
    ...
    encodeMemory([
        ...
        `bakit iwasan ang expectorants`,
        `bakit hindi kainin ang expectorants`,
        `bakit hindi uminom ng expectorants`,    
    ], [
    ...
    encodeMemory([
        ...
        `Mayroon bang mga hindi ka nais-nais na epekto sa paggamit ng expectorants?`,
        ...
        `ano ang side effect ng expectorants`,
        `ano ang hindi magandang epekto ng expectorants`,
    ], [
    ...
    encodeMemory([
        ...
        `ano ang alternatibo sa expectorants`,
        `paano ang alternatibo sa expectorants`,
    ], [
    ...
    encodeMemory([
        ...
        `ano ang branded na antitussives`
    ], [
    ...
    encodeMemory([
        ...
        `anong gamit ng antitussives`,
        `saan ginagamit ang antitussives`,
        `paano ginagamit ang antitussives`,
    ], [
    ...
    encodeMemory([
        ...
        `paano nagpapagaling ang antitussives`
    ], [
    ...
    encodeMemory([
        ...
        `Kailan hindi dapat uminom o magtake ng antitussives`,
        ...
        `bakit hindi kainin ang antitussives`,
        `bakit hindi uminom ng antitussives`,    
    ], [
    ...
    encodeMemory([
        ...
        `ano ang alternatibo sa antitussives`,
        `paano ang alternatibo sa antitussives`,
    ], [
    ...
    encodeMemory([
        ...
        `Anong mga  generic na lozenges ang mabibili sa merkado?`,
    ...
    encodeMemory([
        ...
        `paano iniinom ang lozenges`,
        `paano kinakain ang lozenges`,
    ], [
    ...
    encodeMemory([
        ...
        `saan ginagamit ang lozenges`,
        `paano ginagamit ang lozenges`,
    ], [
    ...
    encodeMemory([
        ...
        `Paano nakakatulong ang lozenges sa pagbabawas ng pag-irita pamamaga sa lalamunan?`,
        `Paano nakakatulong ang lozenges sa pangangalaga sa kalusugan ng lalamunan?`,
        `paano nagpapagaling ang lozenges`
    ], [
    ...
    encodeMemory([
        ...
        `bakit hindi kainin ang lozenges`,
        `bakit hindi uminom ng lozenges`,    
    ], [
    ...
    encodeMemory([
        ...
        `ano ang side effect ng lozenges`,
        `ano ang hindi magandang epekto ng lozenges`,
    ], [
    ...
    encodeMemory([
        ...
        `ano ang mga paalala sa pagkain ng lozenges`,
        `ano ang mga tips sa pagkain o inom ng lozenges`,
    ], [
    ...
    encodeMemory([
        ...
        `sabihin mo sakin ano ang mga porma ng lozenges`
    ], [
    ...
    encodeMemory([
        ...
        `Mayroon bang ibang gamot na maaaring gamitin kaysa sa mga lozenges?`, 
        `Ano ang mga alternatibo sa mga lozenges?`,
        `Mayroon bang natural na paraan para makatulong sa sakit sa lalamunan?`, 
        `ano ang alternatibo sa lozenges`,
        `paano ang alternatibo sa lozenges`,
    ], [
...
let section12 = [
    encodeMemory([
        ...
        `Mayroon bang mga klinika o ospital na pwedeng lapitan para sa trangkaso?`,  
        `Saan pwede magpakonsulta kung may trangkaso?`,  
        `Saang mga healthcare provider o doktor dapat magpatingin kung may trangkaso?`
    ], [
...
let section13 = [
    encodeMemory([
        ...
        `Ano ang mga banta sa kalusugan kapag hindi naibsan ang trangkaso?`,  
        `Ano ang mga delikadong maaring lumabas kung hindi maaagapan ang trangkaso?`,  
        `Ano ang mga komplikasyon ng trangkaso kung hindi ito maagapan?`,  
        `Ano ang mga long-term na epekto sa kalusugan kapag hindi naagapan ang trangkaso?`, 
        `Ano ang mga maaring epekto sa katawan kapag hindi naagapan ang trangkaso?`, 
        `Ano ang mga posibleng epekto kapag hindi naagapan ang trangkaso?`,  
        `May mga posibleng epekto ba sa kalusugan kapag pinabayaan ang trangkaso?`,  
        `Paano makakaapekto sa trabaho o buhay ang hindi pagpapagamot sa trangkaso?`,  
        `Paano nakakaapekto sa kalusugan ang pagpabaya sa trangkaso?`,  
        `ano ang pwede maging problema ng trangkaso`
    ], [
