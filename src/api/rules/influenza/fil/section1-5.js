...
let section4 = [
    encodeMemory([
        ...
        `Ano ang proseso kung bakit ang virus ay nakakapagdulot ng trangkaso sa katawan?`,
        `Ano ang proseso kung bakit nagkakaroon ng influenza dahil sa virus?`,  
        `Bakit nagiging sanhi ng trangkaso ang virus sa katawan?`,  
        `Bakit nagkakaroon ng trangkaso dahil sa virus?`,  
        ...
        `Paano nakakapagdulot ng trangkaso ang virus sa katawan?`,  
...
let section5 = [
    encodeMemory([
        `Ano ang epekto ng pagpapahinga sa paggaling mula sa trangkaso?`, 
        `* pahinga * trangkaso *`,
        `Ano ang mga benepisyo ng pagpapahinga sa paggaling mula sa trangkaso?`, 
        ...
        `Paano nakakapagpahinga ang katawan sa pagpapahinga upang makipaglaban sa trangkaso?`, 
        `Paano nakakatulong ang pagpapahinga sa pagbaba ng lagnat sa panahon ng trangkaso?`, 
        `Paano o Bakit nakakatulong ang pagpapahinga sa paggaling mula sa trangkaso?`, 
    ],[
    ...
    encodeMemory([
        ...
        `Ano ang tamang paraan ng pag-inom ng tubig para makatulong sa pagpapagaling ng trangkaso?`,  
        `Bakit ang tubig ay mas mainam kaysa sa ibang mga inumin kapag may trangkaso?`,  
        `Bakit mahalaga ang pag-inom ng tubig kapag may trangkaso?`,  
        `Gaano karaming tubig ang dapat mong inumin para mapabilis ang paggaling mo sa trangkaso?`,  
        `Magkano ang tubig na dapat mong inumin kapag may trangkaso?`,  
        `May mga pagkaing dapat iwasan kapag may trangkaso, pero bakit hindi kasama dito ang tubig?`,
        `Paano mo malalaman kung sapat na ang naiinom mong tubig para sa pagpapagaling ng trangkaso?`,  
        `Paano nakakatulong ang tubig sa pagpapagaling ng trangkaso?`,  
        `Saan galing ang benepisyo ng pag-inom ng tubig sa pagpapagaling ng trangkaso?`,  
    ],[
    ...
    encodeMemory([
        `* iwasan * pagod * trangkaso *`,
        `Ano ang epekto ng sobrang pagod sa ating katawan habang may trangkaso?`, 
        `Ano ang maaaring mangyari kapag nagpapagod tayo habang may trangkaso?`, 
        `Ano ang mga epekto ng hindi sapat na pahinga sa ating katawan habang may trangkaso?`,
        `Bakit hindi maganda na magpapagod kapag may trangkaso?`, 
        `Bakit mahalaga ang pag-iwas sa pagod para gumaling sa trangkaso?`, 
        `Bakit mahalaga ang sapat na pahinga para sa mabilis na paggaling sa trangkaso?`, 
        `Paano makaaapekto ang sobrang trabaho sa paggaling ng trangkaso?`, 
        `Paano makakaapekto ang sobrang pagod sa ating immune system kapag may trangkaso?`, 
        `Paano makakatulong ang pagpapahinga sa ating katawan habang may trangkaso?`, 
        `Paano nakakatulong ang sapat na pahinga sa ating immune system kapag may trangkaso?`, 
    ],[
    ...
    encodeMemory([
        `* masustansya * trangkaso *`,
        `Ano ang kahalagahan ng pagkakaroon ng sapat na nutrisyon sa paggaling ng trangkaso?`,
        `Ano ang mga pagkain na dapat kainin upang mapabilis ang paggaling sa trangkaso?`,
        `Ano ang mga uri ng pagkain na dapat iwasan habang may trangkaso?`,
        `Bakit dapat kumain ng masusustansyang pagkain para magkaroon ng lakas sa pakikipaglaban sa trangkaso?`,
        `Bakit kailangang magkaroon ng balanced diet para malabanan ang trangkaso?`,
        `Bakit mahalaga ang pagkain ng mga masusustansyang pagkain upang malabanan ang trangkaso?`,
        `Bakit mahalagang kumain ng mga pagkain na mayaman sa protina para makatulong sa pagpapagaling sa trangkaso?`,
        `Paano nakakatulong ang tamang nutrisyon sa pagpapalakas ng resistensya upang maiwasan ang trangkaso?`,
        `Paano nakatutulong ang masusustansyang pagkain sa pagpapalakas ng immune system para labanan ang trangkaso?`,
        `Paano nakatutulong ang mga prutas at gulay sa pagpapalakas ng katawan upang malabanan ang trangkaso?`,
    ],[
    ...
    encodeMemory([
        ...
        `Ano ang mga senyales na hindi dapat balewalain upang magpatingin sa doktor kung may trangkaso?`,
        `Ano ang mga senyales na kailangan ng doktor kung may trangkaso?`,
        `Anong magiging benepisyo kung magkonsulta sa doktor para sa trangkaso?`,  
        `Anong mga gamot o pamamaraan ang maaaring ibigay ng doktor para sa trangkaso?`,  
        `Anong mga impormasyon ang makukuha sa doktor para sa tamang pagpapagamot ng trangkaso?`,  
        `Bakit hindi dapat balewalain ang pagkonsulta sa doktor para sa trangkaso?`,  
        `Bakit hindi dapat mag-self medicate para sa trangkaso at dapat magpakonsulta sa doktor?`,
        ...
        `Kailan nararapat na magpatingin sa doktor kung may trangkaso?`,
        `Kailangan ba ng doktor kung may trangkaso?`,
        `Kailangan ba ng reseta ng doktor kung may trangkaso?`,
        ...
        `Meron bang mga senyales na hindi dapat ikaligta upang magpatingin sa doktor kung may trangkaso?`,
        `Paano magbibigay ng tamang diagnosis ang doktor para sa trangkaso?`,  
        `Paano makakatulong ang doktor upang gumaling sa trangkaso?`,  
        `Paano makakatulong ang doktor upang maiwasan ang posibleng komplikasyon mula sa trangkaso?`,  
        `Sa anong punto dapat magpatingin sa doktor kung may trangkaso?`,
    ],[
    ...
    encodeMemory([
        ...
        `asan ko ba pwede gamuting ang trangkaso`,
        `Alin ang mga lugar na nag-ooffer ng mga gamot para sa trangkaso?`,  
        `Anong mga lugar ang puwede mong puntahan para magpagamot ng trangkaso?`,  
        `Kailangan mo bang pumunta sa doktor o puwede kang magpagaling sa bahay lamang?`,  
        `Mayroon bang mga clinics o hospitals na nagtutugon sa mga taong may trangkaso?`,  
        `Saan ka pupunta kung nais mong magpagamot ng trangkaso?`,  
        `Saan puwedeng magpagamot ng trangkaso?`,  
        `Saang mga establisyemento ka pwedeng magpatingin kung ikaw ay may trangkaso?`,  
        `Saang mga lugar puwedeng makabili ng mga natural na lunas para sa trangkaso?`,
    ],[
    ...
    encodeMemory([
        `* bili * (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) *`,
        `* (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) * bili *`,
        `*  bili * gamot * trangkaso`,
        `Saan makakabili ng gamot tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) para sa trangkaso?`,
        `Nasaan mabibili ang tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) gamot para sa trangkaso?`,
        `Mayroon bang mga botika saan makakabili ng gamot tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) para sa trangkaso?`,
        `Saang mga tindahan makakabili ng gamot tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) para sa trangkaso?`,
        `Anong mga lugar ang nagbebenta ng gamot tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) para sa trangkaso?`,
        `May mga pharmacy ba sa paligid na nagtitinda ng gamot tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) para sa trangkaso?`,
        `Saan nakakabili ng tamang gamot tulad ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin) para sa trangkaso?`,
        `Saan puwedeng bumili ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin)  sa trangkaso?`,
        `Saan maganda bumili ng (analgesics?|ibuprofen|advil|naproxen|paracetamol|aspirin|antihistamines?|benadryl|cetirizine|decongestants?|expectorants?|antitussives?|cough suppressants?|dextromethorphan|guaifenesin|robitussin)  para sa trangkaso?`,
    ],[
    ...
    encodeMemory([
        `* gamot* trangkaso *`,
        `* trangkaso * gamot*`,
        `Ano ang dapat gawin para gumaling mula sa trangkaso?`,
        `Ano ang mga dapat kainin o inumin kapag may trangkaso?`,
        `Ano ang mga dapat kainin o inumin para mapabilis ang pagpapagaling mula sa trangkaso?`,
        `Ano ang mga hakbang na dapat gawin upang malunasan ang trangkaso?`,
        `Ano ang mga pamamaraan na makakatulong sa pagpapagaling mula sa trangkaso?`,
        `Ano ang mga paraan para mabawasan ang  trangkaso?`,
        `May mga gamot ba na pwedeng gamitin upang pagalingin ang trangkaso?`,
        `Mayroon bang mga natural na paraan upang magpagaling mula sa trangkaso?`,
        `Mga dapat gawin para bumuti ang pakiramdam kapag may trangkaso`,
        `Paano magpagaling sa trangkaso sa pamamagitan ng self-care?`,
        `Paano magpakalma ng nararamdaman sa gitna ng trangkaso?`,
        `Paano mapapagaan ang mga trangkaso?`,
        `Paano matutulungan ang sarili na makarekober mula sa trangkaso?`,
        `Paano po ba malunasan ang trangkaso?`, 
        `Ano ang mga paraan upang malunasan ang trangkaso?`,
