...
let section4 = [
    encodeMemory([
        ...
        //chatgpt start
        "Ano ang dahilan kung bakit ang virus ay nakakapagdulot ng influenza o trangkaso?",  
        "Bakit nakakaapekto ang virus sa katawan at nagiging sanhi ng influenza o trangkaso?",  
        "Paano nakakapagdulot ng influenza o trangkaso ang virus sa katawan?",  
        "Ano ang proseso kung bakit nagkakaroon ng influenza o trangkaso dahil sa virus?",  
        "Paano nakakapagdulot ng sakit tulad ng influenza o trangkaso ang mga virus?",  
        ...
        "Paano nakakapagdulot ng mga sintomas ng trangkaso o influenza ang virus sa katawan?",  
    ...
    encodeMemory([
        ...
        "Ano ang mga pangunahing pinanggagalingan ng trangkaso?",
...
let section5 = [
    encodeMemory([
        ...
        //chatgpt start
        "Paano nakakatulong ang pagpapahinga sa paggaling mula sa trangkaso o influenza?", 
        "Bakit nakakatulong ang pagpapahinga sa paggaling mula sa trangkaso o influenza?", 
    ...
    encodeMemory([
        ...
        //chatgpt start
        "Pwede bang magpagamot ng trangkaso o influenza?",
        "May lunas ba sa trangkaso o influenza?",
        "Puwede bang magpatingin sa doktor para sa trangkaso o influenza?",
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        "Nasaan mabibili ang gamot para sa trangkaso o influenza?",
        "Mayroon bang mga botika saan makakabili ng gamot para sa trangkaso o influenza?",
        "Saang mga tindahan makakabili ng gamot para sa trangkaso o influenza?",
        "Anong mga lugar ang nagbebenta ng gamot para sa trangkaso o influenza?",
        "May mga pharmacy ba sa paligid na nagtitinda ng gamot para sa trangkaso o influenza?",
        "Saan nakakabili ng tamang gamot para sa trangkaso o influenza?",
        "Saan puwedeng bumili ng mga pangontra sa trangkaso o influenza?",
        "Saan maganda bumili ng gamot para sa trangkaso o influenza?",
        "Saan makakabili ng mga herbal na gamot para sa trangkaso o influenza?"
        //chatgpt end
    ],[
    ...
    encodeMemory([
        ...
        //chatgpt start
        "Ano ang mga paraan para mabawasan ang sintomas ng trangkaso o influenza?",
        ...
        "Ano ang dapat gawin para gumaling mula sa trangkaso o influenza?", 
         ...
         "Paano mapapagaan ang mga sintomas ng trangkaso o influenza?"
        //chatgpt end
    ],[
