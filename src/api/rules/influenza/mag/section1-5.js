...
let section4 = [
    encodeMemory([
        `* virus * influenza *`,
        `enduken ngin panon a to ka so virus na maka influenza `,
        `panon nginto ka paka influenza i virus`,
    ...
    encodeMemory([
        `* kwa * influenza *`,
        `ngin to ka makakwa gaalatan taw i influenza`,
        `ga kwa na taw i influenza`,
        `panon a to besen i ka kwa gaalatan na influenza su taw`,
    ],[
...
let section5 = [
    encodeMemory([
        `* degka *  influenza *`,
        `panon nginto to ka demegka su taw a aden influenza nin`,
    ...
    encodeMemory([
        ...
        `endaw ako makakwa sa gamot tabang na influenza`,
    ],[
    ...
    encodeMemory([
        ...
        `panon i enggulan na taw amayka nakagedam sa influenza `,
