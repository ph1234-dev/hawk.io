...
let section4 = [
    ...
    encodeMemory([
        ...
        `How does the weak immune system lead to diarrhea?`,
        `What causes weak immune system to trigger diarrhea?`,
        `tell why does weak immune system trigger diarrhea`,
    ],[
        `
    ...
    encodeMemory([
        ...
        `tell why does sweet trigger diarrhea`,
    ...
    encodeMemory([
        ...
        `tell why  does allergy trigger diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `tell why  does malnutrition trigger diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `tell why  does some drugs trigger diarrhea`,
    ],[
    ...
    encodeMemory([
        ...
        `tell why  does parasites trigger diarrhea`,
    ...
    encodeMemory([
        ...
        `tell why  does virus cause diarrhea`,
...
let section5 = [
    ...
    encodeMemory([
        ...
        `How does eating a healthy foods help to treat diarrhea?`,
        ...
        `tell why  does eating healhy foods treat diarrhea`,
    ],[
    ...
    encodeMemory([
        `* buy * (zinc|bismuth|antimotility) * oral * (solutions?|salts?) *`,
        `* buy * diarrhea * drugs *`,
        `* buy * drugs *`,
        `* buy * drugs *`,
    ...
    encodeMemory([
        ...
        `What are some remedies  diarrhea?`,
        ...
        `What steps should I take treat diarrhea?`,
        `how do you treat diarrhea`,
        `is there are way to treat diarrhea`,
    ],[
