...
let section6 = [
    encodeMemory([
      ...
      `ngin to ba ka nasisita su kaawa sa upis na unga bago kanen`,
      `panon a to ba ka nasisita su kaawa sa upis na unga bago kanen`,
    ...
    encodeMemory([
      `* di * kan * da naluto * karne * `,
      `* di * kan * da maluto * karne * `,
      `* di * kan * mailaw * karne * `,
      `enduken a to ka di keman su da maluto a karne`,
      `panon a to ka di keman su da maluto a karne`,
...
let section7 = [
   ...
   encodeMemory([
    ...
    `ngin i mga pegken a kapakay a kanen nu taw a pedtagudo`,
    `ngin i mga pegken a kapakay a pamasan nu taw a pedtagudo`,
...
let section8 = [
    encodeMemory([
      `* diarrhea_foods_not_allowed_bad_hydration * di * (inom|kan|pamasan) * tagudo *`, 
      `* di * (inom|kan|pamasan) * diarrhea_foods_not_allowed_bad_hydration * tagudo * `,  
    ...
    encodeMemory([
      `* di * (inom|kan|pamasan) * diarrhea_foods_not_allowed_oily * tagudo *`, 
      `* diarrhea_foods_not_allowed_oily * di * (inom|kan|pamasan) * tagudo *`, 
