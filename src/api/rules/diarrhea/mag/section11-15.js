...
let section11 = [
    encodeMemory([
        ...
        `ngin e mga generic a mga antimotility a gamot na diarrhea `,
        `enggay ka sa mga ngala na generic a antimotility a gamot na diarrhea `,
        `aden mga generic a antimotility`,
        `ngen i generic a antimotility`,
    ],[
    ...
    encodeMemory([
        ...
        `* branded * antidiarrheal * drugs *`,
        `* branded * gamot * diarrhea *`,
        `ngen i mga ngala na branded a antimotility a gamot na kapedtagudo`,
        `ngin e mga branded a mga antimotility a gamot na diarrhea `,
        `enggay ka sa mga ngala na branded a antimotility a gamot na diarrhea `,
        `aden brand na antimotility`,
        `ngen i branded a antimotility`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin i nakasugat a ukit ka kainom sa antimotility`,
        `ngin i nakasugat a ukit kagamot sa antimotility`,
        `panon i kainom sa antimotility`,
        `panon i kainom sa gamot a antimotility`,
        `panon i kakan sa gamot a antimotility`,
        `panon i kapegkan sa antimotility`,
        `panon i kapenggamot sa antimotility`,
        `ngin i dose na antimotility`,
        `panon i dose na antimotility`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin besen i penggamutan na loperamide `,
        `edaw i loperamide  kagamit`,
        `di ko katawan ngin i antimotility`,
        `kano i kakan, kainom, kanggamot sa antimotility`,
        `ngin i gamit na antimotility`,
    ],[
    ...
    encodeMemory([
        `*galbek * antimotility *`,
        `* antimotility * galbek * `,
        `panon i kapenggalbek na loperamide   sa tagudo`,
        `ngin i galbek na loperamide   sa tagudo`,
    ...
    encodeMemory([
        ...
        `kano i di kakan  sa loperamide `,
        `kano i di kagamit sa loperamide `,
        `kano i di kainom sa loperamide `,
        `nginto ka di mapakay a enggamot sa loperamide `,
        `nginto ka di mapakay a keman sa loperamide `,
        `nginto ka di mapakay a minom sa loperamide `,
        `ngen to ka so loperamide  na di mapya a gamiten nu taw a pedtagudo`,
        `ngen to ka so loperamide  na di mapya a kanen nu taw a pedtagudo`,
        `ngen to ka so loperamide  na di mapya a inomen nu taw a pedtagudo`,
        `enduken ka di minom sa loperamide  i taw a pedtagudo`,
        `enduken ka di keman sa loperamide  i taw a pedtagudo`,
    ...
    encodeMemory([
        ...
        `ngen i di mapya a manggula na taw a mininom sa loperamide `,
        `ngen i di mapya a manggula na taw a keman sa loperamide `,
        `ngen i mga di mapya a epekto amayka keman i taw sa loperamide `,
        `ngen i mga di mapya a epekto amayka minom i taw sa loperamide `,
    ...
    encodeMemory([
        ...
        `aden mga tips nengka san sa kanggamot sa antimotility`,
        `aden mga tips nengka san sa kakan sa antimotility`,
        `aden mga tips nengka san sa kainom sa antimotility`,
    ...
    encodeMemory([
        ...
        `ngen i mga balangan o buntal na loperamide `,
    ...
    encodeMemory([
        ...
        `ngen i kaped a gamot a gapakay isambi sa loperamide `,
        `aden pan kaped a gamot a mapakay inomen na taw lyu sa loperamide  para kagamotan i kapedtagudo`,
        `aden pan kaped a gamot a mapakay kanen na taw lyu sa loperamide  para kagamotan i kapedtagudo`,
    ...
    encodeMemory([
        ...
        `ngin e mga generic a mga bismuth subsalicylate a gamot na diarrhea `,
    ...
    encodeMemory([
        ...
        `ngin i nakasugat a ukit kakainom  sa bismuth subsalicylate`,
        `ngin i nakasugat a ukit ka kapegkan sa bismuth subsalicylate`,
        `panon i kapenggamot sa bismuth subsalicylate`,
        `panon i kapegkan sa bismuth subsalicylate`,
        `panon i kainom a bismuth subsalicylate`,
        `panon i kainom sa gamot a bismuth subsalicylate`,
        `panon i kakan sa gamot a bismuth subsalicylate`,
        `di ko katawan i kapegkan sa bismuth subsalicylate`,
        `ngin i dose na bismuth`,
        `panon i dose na bismuth`,
    ],[
    ...
    encodeMemory([
        ...
        `kano i di kagamit sa bismuth subsalicylate`,
        `kano i di kakan sa bismuth subsalicylate`,
        `kano i di kainom  sa bismuth subsalicylate`,
        `nginto ka di mapakay a enggamot sa bismuth subsalicylate`,
        `nginto ka di mapakay a keman sa bismuth subsalicylate`,
        `nginto ka di mapakay a minom sa bismuth subsalicylate`,
        `ngen to ka so bismuth subsalicylate na di mapya a kanen , inomen o gamiten nu taw a pedtagudo`,
        `enduken ka di keman sa bismuth subsalicylate i taw a pedtagudo`,
        `enduken ka di minom sa bismuth subsalicylate i taw a pedtagudo`,
        ...
        `di ko katawan panon i kanggamot sa bismuth subsalicylate`,
        `di ko katawan panon i kakan sa bismuth subsalicylate`,
        `di ko katawan panon i kainom  sa bismuth subsalicylate`,
    ...
    encodeMemory([
        ...
        `aden pan kaped a gamot a mapakay kanen na taw lyu sa bismuth subsalicylate  para kagamotan i kapedtagudo`,
        `aden pan kaped a gamot a mapakay inomen na taw lyu sa bismuth subsalicylate  para kagamotan i kapedtagudo`,
        `aden mga gamot a mapakay enggamuten a pakasambi sa bismuth subsalicylate`,
        `aden mga gamot a mapakay kanen a pakasambi sa bismuth subsalicylate`,
        `aden mga gamot a mapakay inumen a pakasambi sa bismuth subsalicylate`,
    ],[
