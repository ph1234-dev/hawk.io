...
data.push(
    ...
    encodeMemory([
        ...
        `sabihin mo nga sakin anong pwede kong gawin barado ilong lp`,
        `parang barado ilong ko`,
        `barado ang ilong ko`,
    ],[
