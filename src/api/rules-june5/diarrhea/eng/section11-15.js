...
let section11 = [
    ...
    encodeMemory([
        ...
        `There is Imodium which is a branded name for antimotility.  To avoid possible side effects or complications, the recommended dosage and use instructions should be followed.`
    ],7),
    encodeMemory([
        `* what * (dosing|direction) * antimotility *`,
        `* how * (take|use) * antimotility *`,
        `* how * antimotility * (take|use) *`,
        `How many antimotility tablets should I take?`,
        `How much antimotility should I take?`,
        `How should I take antimotility?`,
        `How should one take antimotility ?`, 
        `What are the instructions for taking antimotility ?`,
        `What is the advised way to take antimotility ?`, 
    ...
    encodeMemory([
        `* what * is * antimotility *`,
        `What are the benefits or properties of antimotility?`,
        `What class of drug is antimotility?`,
    ...
    encodeMemory([
        `* what * antimotility * use  *`,
        `In what cases is antimotility recommended?`,
        `What ailments is antimotility prescribed for?`,
        `What are the benefits of taking antimotility?`,
        `What are the therapeutic applications of antimotility?`,
        ...
        `What is the clinical use of antimotility?`,
        `What is the purpose of antimotility?`,
        `What medical problems can antimotility help with?`,
    ],[
    ...
    encodeMemory([
        ...
        `How does antimotility reduce stool frequency or slow down bowel movements?`,  
    ...
    encodeMemory([
        `* (why|who|when) * (avoid|not (take|use)) * antimotilities *`,
        `* (why|who|when) * antimotilities * (avoid|not (take|use)) *`,
        `* antimotility * not (take|use) * (why|who|when) *`,
        `Are there any individuals who should not take on the counter drugs such as antimotility`,
        `In what situations should antimotility not be used?`,  
        `What are the cases or circumstances where antimotility is not safe to use and  in which it should not be taken?`,  
        `What are the precautions to be taken while using antimotility?`,  
        `What are the reasons to avoid taking antimotility or why antimotilities should not be taken?`,  
        `What groups of people should avoid taking on the counter drugs  like antimotility`,
        `When is it necessary to avoid or recommended to take antimotility?`,  
        `When should antimotility be avoided?`,  
        `Which people should not take on the counter drugs  such as antimotility`,
        `Who is not recommended to take on the counter drugs like antimotility`,
        `Who should be careful when taking on the counter drugs such as  antimotility`,
        `Who should consult a doctor before taking on the counter drugs  such as  antimotility`,
        `Who should refrain from taking on the counter drugs  such as  antimotility`,
        `Why are antimotilities not recommended?`,
        `Why is it important to avoid taking antimotilities unless prescribed by a doctor?`,
    ...
    encodeMemory([
        `* what * side effect * antimotility *`,
        `What are the side effects of antimotilities`,
        `What are the risks of taking antimotilities `,
        `What are the risks of taking on the counter drugs  such as  antimotility`,
        ...
        `Are there any precautions I should take before using antimotility?`,
        `Are there any risks associated with taking antimotility?`,
        `Can taking antimotility cause any complications or for diarrhea be harmful??`,
        `What are the adverse events associated with antimotility?`,
        `What are the effects of antimotility?`,
        `What are the potential or possible risk, side effects, drawbacks,adverse effects, complications or downsides of using or taking antimotility?`,
        `What are the possible negative reactions to antimotility?`,
        `What are the possible risks of taking antimotility in certain situations?`,
        `What are the potential hazards or unwanted effects of antimotility?`,
        ...
        `What are the undesirable symptoms of taking antimotility?`,
    ],[
    ...
    encodeMemory([
        ...
        `Antimotilities are available in various forms such as tablets, capsules, liquids and suspensions. Rectally administering certain medicinal products such as suppositories or enemas may also be possible. Loperamide, which is available in both tablets and liquid forms, is a very common antimotility medicine.`
    ],7),
    encodeMemory([
        `* what * alternative * antimotility *`,
    ...
    encodeMemory([
        ...
        `Bismuth subsalicylate is a generic drug that can be bought in pharmacies. To avoid possible side effects or complications, the recommended dosage and usage instructions should be followed.`
    ],7),
    encodeMemory([
        ...
        `Some of the known ones are Pepto-Bismol and Bismatrol. To avoid possible side effects or complications, the recommended dosage and usage instructions should be followed.`
    ],7),
    encodeMemory([
        ...
        `What are the instructions or directions for taking bismuth subsalicylate?`,
        `What is the best or proper way to take bismuth subsalicylate?`,
    ...
    encodeMemory([
        ...
        `What is the composition, meaning, or definition of bismuth subsalicylate?`,  
    ...
    encodeMemory([
        ...
        `What are the benefits or uses of bismuth subsalicylate?`,
        `What are the indications for bismuth subsalicylate?`,
        `What are the medical or therapeutic uses of bismuth subsalicylate?`,
        `What conditions is bismuth subsalicylate used to treat?`,
        `What is bismuth subsalicylate prescribed or used for?`,
    ...
    encodeMemory([
        ...
        `How does bismuth subsalicylate reduce symptoms or work in the treatment of diarrhea?`, 
    ...
    encodeMemory([
        `* (why|who|when) * ( not  (take|use) | avoid )  * (bismuth)? * (subsalicylate)? *`,
        `* (why|who|when) * ( not  (take|use) | avoid )  *  subsalicylate *`,
        `* (why|who|when) * ( not  (take|use) | avoid )  *  bismuth *`,       
        `In what situations should bismuth subsalicylate not be used?`,  
        `What are the cases where bismuth subsalicylate is not safe to use and  in which it should not be taken?`,  
        `What are the reasons to avoid taking bismuth subsalicylate or why it should not be taken?`,  
        `What groups of people should avoid taking on the counter drugs  like bismuth subsalicylate `,
        `When is it necessary to avoid or not recommended to take bismuth subsalicylate ?`,  
        `When should bismuth subsalicylate  be avoided?`,  
        `Which people should not take on the counter drugs  such as  bismuth subsalicylate `,
        `Who is not recommended to take on the counter drugs like bismuth subsalicylate `,
        `Who should be careful when  or refrain from  taking on the counter drugs such as  bismuth subsalicylate `,
        `Who should taking on the counter drugs  such as  bismuth subsalicylate `,
        `Why are bismuth subsalicylate  not recommended?`,
        `Why is it important to avoid taking bismuth subsalicylate unless prescribed by a doctor?`,
        `Why is it not recommended to take bismuth subsalicylate  `,
        `Why should we avoid taking or not take on the counter drugs such bismuth subsalicylate  `,
    ],[
    ...
    encodeMemory([
        `* what * side effect * bismuth subsalicylate *`,
        ...
        `What are the possible side effects of bismuth subsalicylate on the body?`, 
...
let section12 = [
    ...
    encodeMemory([
        ...
        `Can you describe or explain chronic diarrhea?`,
        `How is chronic diarrhea defined or different from regular diarrhea?`,
    ...
    encodeMemory([
        ...
        `What natural remedies are available for acute diarrhea?`,  
...
let section14 = [
    ...
    encodeMemory([
        ...
        `What are the common symptoms or physical indicators of diarrhea?`,
        `What are the cues of diarrhea?`,
        `What are the features of diarrhea?`,
        `What are the symptoms or traits of diarrhea?`,
