...
let section4 = [
    ...
    encodeMemory([
        ...
        `Nu malubay a immune system na di pakagagasa sa katabang sa lawas nengka sa mga pathogens. Nya ba silan na pakalebag sa tinae na pakadtagudo. 
    ...
    encodeMemory([
        ...
        `ngin besen i to ka pakadtagudo kon i kakan sa mga mamis a benel`,
    ],[
    ...
    encodeMemory([
        ...
        `panon a to ka edtagudo su taw a aden allergy nin`,
        `ngin to ka pakadtagudo i aden pakagedam sa allergy`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin sabap nin ka upama ka naka kwa sa kagaw na aw na to na edtagudo ka`,
        `ngin to ka edtagudo su taw sabap sa bacteria`,
    ],[
    ...
    encodeMemory([
        ...
        `panon a to ka so virus infection na makadtagudo`,
        `ngin to ka edtagudo su taw sabap sa virus`,
    ],[
...
,
    ...
    encodeMemory([
        ...
        `ngin to ka pedtagudo besen i taw`,
        `ngin i sabap nin ka pedtagudo su taw`,
        `Ngin to ka su taw na edtagudo`,
        `Ngin to ka edtagudo su taw`,
    ],[
    ...
    encodeMemory([
        `* ngin * enggay * tagudo * `,
        `* ngin * makadtagudo * `,
        `panon besen i ka kadtagudo nu taw`,
        `panon a to ka pedtagudo su taw`,
        `ngin to ka su taw na makagedam sa mana sekanin pedtagudo`,
        `ngen to ka edtagudo i taw`,
    ],[
...
let section5 = [
    encodeMemory([
        ...
        `ngin to o panon a to ka su kainom sa ig na makagkapya sa taw a pedtagudo`,
        `Ngin to o panon a to ka nasisita su kapaginom sa ig amayka pedtagudo su taw`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin to ka pakagamot su kakan sa zinc sa taw a pedtagudo`,
        `duken ka su zinc na pakagamot sa kabedtagudo`,
        `panon a to ka su taw a pedtagudo na kagamutan na kakan sa zinc`,
        `ngin to o panon a to ka su kainom sa zinc na makagkapya sa taw a pedtagudo`,
        `Ngin to o panon a to ka nasisita su kapaginom sa zinc amayka pedtagudo su taw`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin to o panon a to ka su kakan sa mapya na makagkapya sa taw a pedtagudo`,
        `Ngin to o panon a to ka su keman sa mapya a pegken  amayka pedtagudo su taw`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin to o panon a to ka mangay i enggagaysa o su taw da doctor amayka pedtagudo`,
        `Ngin to o panon a to ka su kaangay sa doctor na makagkapya amayka pedtagudo su taw`,
    ],[
    ...
    encodeMemory([
        `* (awa|gamot|kapya|tabang) * tagudo * (panon|ngen) * `,
        `* (panon|ngen) * (awa|gamot|kapya|tabang) * tagudo * `,
        `* (panon|ngen) * tagudo * (awa|gamot|kapya|tabang) * `,
        `* tagudo * (awa|gamot|kapya|tabang) * (panon|ngen) *`,
        `labit ka i mapya a ebpasen nu taw a pedtagudo`,
        `labit ka sa mapakay a galbeken nu taw a pedtagudo`,
        `nganin nganin o ngin i dayt a igamot sa taw a pedtagudo`,
        `nganin nganin o ngin i enggulan nu taw upama ka pedtagudo sekanin`,
        `nganin nganin o ngin i galbeken na taw a pakagedam sa kapedtagudo`,
        `nganin nganin o ngin i mapakay a igamot sa taw a pedtagudo`,
        `nganin nganin o ngin i mapya a ebpasen amayka pedtagudo`,
        `nganin nganin o ngin i mga gamot nu taw a pedtagudo`,
        `nganin nganin o ngin i mga kapakay a igamot sa pedtagudo a taw`,
        `pano o ngin i enggulan na taw amayka pedtagudo sekanin`,
        `panon o ngin i enggulan sa taw a pedtagudo den pedtandang`,
        `panon o ngin i katabang sa taw a pedtagudo`,
        `* panon * gamot * tagudo * `,
        `panon i kapenggamot sa tagudo`,
        `ngen i enggulan sa taw a pedtagudo`,
        `panon i kagamot sa pedtagudo`,
        `ngin i gamiten nu taw engu pegkabagel i taw a pedtagudo`,
        `pano i kagkapya na mangegedam a taw a pedtagudo`,
        `ngin i enggulan na pedtagudo`,
    ...
    encodeMemory([
        ...
        `Kanu i ka lu sa doctor amayka pedtagudo`,
        `kano i kandoctor upama ka pedtagudo su taw`,
        `kano i ka angay sa doctor amayka pedtagudo`,
        `pila gay angatan bago blu sa doctor amayka pedtagudo`,
        `panon i kataw amayka nasisita i kapailay sa doctor`,
        `panon na to ka nasisita su kaangay sa doctor.`
    ],[
    ...
    encodeMemory([
        `* endaw * (kwa|pamasa) * (zinc|bismuth|antimotility) oral rehydration (solutions?|salts?) * `,
        `* endaw * (zinc|bismuth|antimotility) oral rehydration (solutions?|salts?) *  (kwa|pamasa) *`,
    ...
    encodeMemory([
        `* (panon|ngen|nginto) * (tabang|enggulan|kapya) * lugo * (tagudo|tai) *`,
        `* lugo * (tagudo|tai) * ngen * (tabang|enggulan|kapya) * `,
        `ngin i mapya a enggulan nu taw a to pebpilugo abpeg a pedtagudo`,
        `panon i kagamot o katabang sa taw a pedtagudo ugayd na pebpaugo`,
        `aden lugo nin tapos pedtagudo pan sekanin`,
        `ngin i galbeken nu taw a nakailay sa lugo sa kinadtagudo nin`,
        `ngin i mapya a galbeken nu taw a pedtagudo`,
    ],[
    ...
    encodeMemory([
        ...
        'ngen i enggulan o nu taw amayka pegkayaw sekanin abpeg a pedtagudo ',
        `amayka pedtagudo su taw na mayaw pan i kanggegedam nin na ngin e enggulan nin`,
        `panon i pakairan sa ginawa nu taw a pedtagudo na aden mayaw nin`,
        `ngin e galbeken nu taw a pegkayaw abpeg a pedtagudo`,
    ],[
