...
let section11 = [
    encodeMemory([
        ...
        `ngen i mga ngala na generic a antimotility a gamot na kapedtagudo`,
        `ngin e mga generic a mga antimotility a gamot na diarrhea o kapedtagudo`,
        `enggay ka sa mga ngala na generic a antimotility a gamot na diarrhea o tagudo`,
        `aden mga generic a antimotility`,
    ],[
    ...
    encodeMemory([
        ...
        `ngin e mga branded a mga antimotility a gamot na diarrhea o kapedtagudo`,
        `enggay ka sa mga ngala na branded a antimotility a gamot na diarrhea o tagudo`,
        `aden brand na antimotility`,
    ],[
    ...
    encodeMemory([
        `* ngen * dose * antimotility *`,
        `* panon * (gamit|kan|inom) * antimotility * `,
        `* ngen * ukit * antimotility * `,
        `* panon * antimotility * (gamit|kan|inom) * `,
        `ngin i nakasugat a ukit ka kapegkan , kagamot o kainom sa antimotility`,
        `panon i kapegkan  o kainom o kapenggamot sa antimotility`,
        `panon i kakan o kainom sa gamot a antimotility`,
    ...
    encodeMemory([
        `* ngen * antimotility * `,
        `ngin i pidtalo o pidtalu a loperamide o imodium`,
        `ngen besen i loperamide o imodium`,
    ...
    encodeMemory([
        `* endaw * antimotility * gamit * `,
        `* endaw * gamit * antimotility *`,
        `endaw kagamit i loperamide o imodium`,
        `ngin besen i penggamutan na loperamide o imodium`,
        `edaw i loperamide o imodium kagamit`,
        `di ko katawan ngin i antimotility`,
    ...
    encodeMemory([
        `* panon * galbek * antimotility *`,
        `* panon * antimotility * galbek * `,
        `panon i kapenggalbek na loperamide o imodium  sa tagudo`,
        `ngin i galbek na loperamide o imodium  sa tagudo`,
        `panon besen i kapenggamot na loperamide o imodium sa tagudo`,
    ...
    encodeMemory([
        `* kano * di * (kan|inom|gamit) * antimotility * `,
        `kano i di kakan , kainom o kagamit sa loperamide o imodium`,
        `nginto ka di mapakay a keman, minom o enggamot sa loperamide o imodium`,
        `ngen to ka so loperamide o imodium na di mapya a kanen , inomen o gamiten nu taw a pedtagudo`,
        `enduken ka di keman o minom sa loperamide o imodium i taw a pedtagudo`,
        `panon a to ka di mapakay a keman i taw sa loperamide o imodium i taw a pedtagudo`,
    ...
    encodeMemory([
        ...
        `ngen i di mapya a manggula na taw a keman o mininom sa loperamide o imodium`,
        `ngen i mga di mapya a epekto amayka keman o minom i taw sa loperamide o imodium`,
        `labit ka sa mga di mapya epekto sa taw na loperamide o imodium`,
        `panon a to ka aden di mapya epekto na loperamide o imodium`,
    ...
    encodeMemory([
        `* ngen * (tips|enggulan) *  antimotility * `,
        `enggay ka sa mga tanda na kapegkan sa loperamide o imodium`,
        `panon i mga ula ula na kapegkan sa loperamide o imodium`,
        `aden mga tips nengka san sa kakan, kainom o kanggamot sa antimotility`,
    ],[
    ...
    encodeMemory([
        `* pila * antimotility * `,
        `* antimotility * pila * `,
        `ngen i alaga na loperamide o imodium`,
        `gagapila i loperamide o imodium`,
        `pila i alaga na loperamide o imodium`,
    ],[
    ...
    encodeMemory([
        ...
        `ngen i mga balangan o buntal na loperamide o imodium`,
        `ngen i mga embalangan nu gamot a loperamide o imodium`,
    ...
    encodeMemory([
        `* sambi * antimotility * `,
        `ngen a mga gamot i mapakay i sambi sa loperamide o imodium`,
        `ngen i kaped a gamot a gapakay isambi sa loperamide o imodium`,
        `aden pan kaped a gamot a mapakay inomen o kanen na taw lyu sa loperamide o imodium para kagamotan i kapedtagudo`,
        `di ko katawan ngen i kaped a gapakay pegkanen lyu sa antimotility`,
        `aden mga pakasambi a gamot sa antimotility a mapakay kanen, inomen, enggamuten nu taw`,
    ],[
    ...
    encodeMemory([
        ...
        `ngen i mga ngala na generic a bismuth subsalicylate a gamot na kapedtagudo`,
        `ngin e mga generic a mga bismuth subsalicylate a gamot na diarrhea o kapedtagudo`,
        `enggay ka sa mga ngala na generic a bismuth subsalicylate a gamot na diarrhea o tagudo`,
        `di ko katawan ngin i mga generic a bismuth subsalicylate`,
        `aden generic a bismuth subsalicylate`,
    ],[
    ...
    encodeMemory([
        ...
        `ngen i mga ngala na branded a bismuth subsalicylate a gamot na kapedtagudo`,
        `ngin e mga branded a mga bismuth subsalicylate a gamot na diarrhea o kapedtagudo`,
        `enggay ka sa mga ngala na branded a bismuth subsalicylate a gamot na diarrhea o tagudo`,
    ...
    encodeMemory([
        ...
        `ngin i nakasugat a ukit ka kapegkan o kainom  sa bismuth subsalicylate`,
        `panon i kapegkan  o kainom o kapenggamot sa bismuth subsalicylate`,
        `panon i kakan o kainom sa gamot a bismuth subsalicylate`,
        `di ko katawan i kapegkan sa bismuth subsalicylate`,
    ],[
    ...
    encodeMemory([
        ...
        `ngen i pidtalo o pedtalon a bismuth subsalicylate `,
    ...
    encodeMemory([
        ...
        `endaw kagamit i bismuth subsalicylate`,
        `ngin besen i penggamutan na bismuth subsalicylate`,
        `edaw i bismuth subsalicylate kagamit`,
        `di katawan i penggulan na bismuth subsalicylate`,
        `kanu i kakan, kanggamot, kainom sa bismuth subsalicylate`,
    ],[
    ...
    encodeMemory([
        ...
        `panon i kapenggalbek na bismuth subsalicylate sa tagudo`,
        `ngin i galbek na bismuth subsalicylate sa tagudo`,
        `panon besen i kapenggamot na bismuth subsalicylate sa tagudo`,
        `di katawan ngin i galbek na bismuth subsalicylate`,
    ],[
    ...
    encodeMemory([
        ...
        `kano i di kakan , kainom o kagamit sa bismuth subsalicylate`,
        `nginto ka di mapakay a keman, minom o enggamot sa bismuth subsalicylate`,
        `ngen to ka so bismuth subsalicylate na di mapya a kanen , inomen o gamiten nu taw a pedtagudo`,
        `enduken ka di keman o minom sa bismuth subsalicylate i taw a pedtagudo`,
        ...
        `di ko katawan panon i kakan, kainom o kanggamot sa bismuth subsalicylate`,
        `aden taw a di mapakay keman, minom, o enggamot sa bismuth subsalicylate`,
    ],[
    ...
    encodeMemory([
        ...
        `ngen i di mapya a manggula na taw a keman o mininom sa bismuth subsalicylate`,
        `ngen i mga di mapya a epekto amayka keman o minom i taw sa bismuth subsalicylate`,
    ...
    encodeMemory([
        ...
        `ngen i alaga na bismuth subsalicylate`,
        `pila i alaga na bismuth subsalicylate`,
    ],[
    ...
    encodeMemory([
        ...
        `ngen a mga gamot i mapakay i sambi sa bismuth subsalicylate `,
        `ngen i kaped a gamot a gapakay isambi sa bismuth subsalicylate `,
        `ngen pan i mapakay a enggamuten nu taw a pedtagudo`,
        `ngin pan i kanen a gamot a taw a pedtagudo`,
        `aden pan kaped a gamot a mapakay inomen o kanen na taw lyu sa bismuth subsalicylate  para kagamotan i kapedtagudo`,
        `aden mga gamot o pegken a mapakay kanen, inumen, o enggamuten a pakasambi sa bismuth subsalicylate`
    ],[
...
let section12 = [
    encodeMemory([
        ...
        `endaw mapakay penggamotan i kapedtagudo`,
        `endaw kagamutan su tagudo`,
...
let section13 = [
    encodeMemory([
        ...
        `ngin i mga di mapya a manggula na taw a pedtagudo`,
...
let section14 = [
    ...
    encodeMemory([
        ...
        `nganin nganin i mga sintomas na tagudo`,
        `ngin i ilayn sa taw a pedtagudo`,
