...
data.push(
    ...
    encodeMemory([
        ...
        `
        Su nausea na namba i bedtuan sa kangedam nu taw bago sekanin manguta. Namba na sabap sa motion sickness, sakit na tyan, di mapya epekto na gamot, engo kaped a dalo na lawas. Endu pegkapya i kangegedam nengka, na degka ka, inom ka sa ig, sports drinks, abpeg sabaw. Da ka pa pegkan sa mga sinendag, lanan a pegken abpeg su mga aden mamis nin. Nya ka enggula na tekaw ka kan sa mga da ged nanam nin a mga pegken mana su saltine crackers o pan sa embabadyo. Upama ka demegka ka na pangilay ka sa kalaganan nu ulo nengka. `
    ],4),
)
...
data.push(
    encodeMemory([
        ...
        `pano i mga embalangan na ka limpyo sa ig`,
...
data.push(
    ...
    encodeMemory([
        ...
        `ngen i enggulan na taw a pegkayaw`,
        `ngen i mapakay a galbeken na taw a pegkegkel`,
...
data.push(
    encodeMemory([
        ...
        `ngen i pakaira nu taw upama ka masakit i ulo nin`,
        `panon i galbeken nu taw amayka pedsakit i ulo nin`,
