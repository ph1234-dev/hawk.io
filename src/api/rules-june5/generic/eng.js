...
data.push(encodeMemory([
    `* (why|how) * hydrate * treat *`,
    `* (why|how) * take * water * treat *`,
...
// healthy food
data.push(encodeMemory([
    `* (why|how) * healthy * food  * treat * `,
    `How does a balanced diet aid in digestion and reduce symptoms?`,
...
data.push(encodeMemory([
    ...
    `Is there a specific place to buy  medication ,antimotility, oral rehydration solution salt?`,
...
data.push(
    encodeMemory([
        `* (what|how) * (treat|reduce|control|TAKE) * (vomit|vomiting) *`,
        `How to manage, handle,prevent,reduce,supress vomiting?`,
        `What are anti-vomiting techniques?`,
        `What are bland foods to eat after vomiting?`,  
        `What are easily digestible foods to eat after vomiting?`,  
        `What are foods to eat after vomiting?`,  
        `What are healthy foods to eat after vomiting?`,  
        `What are natural ways to control vomiting?`,
        `What are recommended drinks or foods to eat and have after vomiting?`,  
        `What are the remedies, measures or ways to ease or stop vomiting?`,
        `What are vomiting management strategies?`,
        `What can I do to manage or eat after throwing up or vomiting?`,  
        `What can I eat to replenish my body or help my stomach after vomiting?`,
        `What can be done to control vomiting?`,
        `What foods should I avoid or consume after vomiting?`,  
...
data.push(
    ...
    encodeMemory([
        `* (what|how) * (treat|reduce|control|TAKE) * (nauseouss|nausea) *`,
        `How can I prevent , alleviate, or cope with nausea?`,
        `How do I control or deal with nausea?`,
        `What are foods or drinks that can help with nausea?`,
        `What are foods that can be eaten after experiencing nausea?`,
        `What are foods that won't upset my stomach after experiencing nausea?`,
        `What are good foods to eat after nausea?`,
        `What are lifestyle changes that can help with nausea?`,
        `What are light foods that can be eaten after experiencing nausea?`,
        ...
        `What to do and eat foods are gentle on the stomach after nausea?`,
        ...
        `Which foods should I do after nausea to avoid making it worse?`,
...
data.push(
    encodeMemory([
        `* (what|steps|how)* disinfect * water *`,
...
data.push(
    // 
    encodeMemory([
        `* (what|how) * (treat|reduce|control) * (chills|fever) *`,
...
data.push(
    ...
    encodeMemory([
        `* (what|how) * (treat|reduce|control) * (stuff|clog) * nose *`,
...
data.push(
    encodeMemory([
        `* (what|how) * treat * (head|headache|dizzy) *`,
