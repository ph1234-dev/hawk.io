...
let section11 = [
    ...
    encodeMemory([
        ...
        `Can you describe how antihistamine are used to relieve allergy symptoms?`,  
        `Can you tell me how antihistamine reduce allergy symptoms?`,  
        `Explain how antihistamine inhibit allergic reactions`,  
        `Explain how antihistamine work to relieve allergy symptoms`,  
        `How do antihistamine block the effects of histamines in the body?`,  
        `How do antihistamine treat allergy symptoms?`,  
        ...
        `What is the process by which antihistamine relieve allergy symptoms?`,  
        `What is the purpose of antihistamine?`,  
        `What is the way in which antihistamine affect the body's response to allergens?`,
        `What is the way in which antihistamine alleviate allergy symptoms?`,  
    ],[
    ...
    encodeMemory([
        ...
        `What are the precautions I need to take before using antihistamine?`,
    ...
    encodeMemory([
        ...
        `What are the guidelines or instructions for taking or  precautions when expectorants?`,
...
let section14 = [
    ...
    encodeMemory([
       ...
       `I can provide you basic information on influenza such as the symptoms, causes, things to avoid, foods you can and shouldnt take, the treatments, and how to manage it. Further, I can explain these to help you perform self-care. However, I not a medical practicitioner and the information I provide are meant for awareness only. If you find the it inadequate , it is best to ask your doctor for advises. `
    ],1),
    encodeMemory([
