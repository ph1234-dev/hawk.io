...
let section6 = [
    ...
    encodeMemory([
        ...
        `Why is it advised to maintain distance from others when you have influenza?`,
    ...
    encodeMemory([
        ...
        `Why do doctors recommend wearing a face mask when you have the flu?`,
...
let section7 = [
    ...
    encodeMemory([
        `* influenza_foods_allowed * (take|good|buy) * influenza *`,
        `* why * (take|good|buy)  * influenza_foods_allowed * influenza *`,
    ...
    encodeMemory([
        `* (treat|take|good) * food * influenza *`,
        `* food *  influenza  * (treat|take|good) *`,
        `* food * (treat|take|good) * influenza *`,
        `Are there any foods I should take when I have the flu?`,
        `Are there any specific foods that can help with flu symptoms?`,
...
let section8 = [
    ...
    encodeMemory([
        ...
        `What is the impact of eating influenza_foods_not_allowed on influenza symptoms?`,
        `What is the reason for avoiding influenza_foods_not_allowed when you have influenza?`,
        `Why is it advised not to eat influenza_foods_not_allowed when you have influenza?`,
    ...
    encodeMemory([
        ...
        `Can caffeinated drinks worsen the symptoms of influenza? Why?`,
        `Does consuming caffeinated drinks prolong the recovery time from influenza? Why?`,
        `How does consuming caffeinated drinks affect influenza symptoms?`,
        ...
        `What's the connection between caffeinated drinks and influenza symptoms?`,
    ...
    encodeMemory([
        ...
        `Can greasy, deep fried or oily foods worsen the symptoms of influenza? Why?`,
        `Does consuming greasy, deep fried or oily foods prolong the recovery time from influenza? Why?`,
        `How does consuming greasy, deep fried or oily foods affect influenza symptoms?`,
        ...
        `What is the impact of eating influenza_foods_not_allowed_greasy_foods on influenza symptoms?`,
        ...
        `Why is it advised not to eat influenza_foods_not_allowed_greasy_foods when you have influenza?`,
    ...
    encodeMemory([
        ...
        `Why is it advised not to eat influenza_foods_not_allowed_hard_grains when you have influenza?`,
        ...
        `What is the impact of eating influenza_foods_not_allowed_hard_grains on influenza symptoms?`,
    ...
    encodeMemory([
        ...
        `What is the impact of eating influenza_foods_not_allowed_sugary_foods on influenza symptoms?`,
        ...
        `Why is it advised not to eat influenza_foods_not_allowed_sugary_foods when you have influenza?`,
    ...
    encodeMemory([
        ...
        `I'm not sure which foods to avoid when I have influenza. Can you advise me?`,
        `What are the foods I should stay away from when I have influenza?`,
        `What are the foods that can make my influenza symptoms worse?`,
...
let section10 = [
    ...
    encodeMemory([
        ...
        `Who is susceptible to severe flu symptoms?`,
        `Who may experience severe symptoms when they have the flu?`,
        ...
        `Who should take extra precautions during flu season?`,
