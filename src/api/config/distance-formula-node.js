...
let input = "diarrhea going a complication"
let p1 = "complication diarrhea diarrhea diarrhea diarrhea"
let p2 = "take antimotility cause complication diarrhea harm"

console.log(`Cosine similarity input and p1: ${cosineSimilarity(input,p1)}`)
console.log(`Cosine similarity input and p2: ${cosineSimilarity(input,p2)}`)