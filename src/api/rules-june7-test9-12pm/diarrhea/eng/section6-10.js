...
let section8 = [
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_bad_hydration * not * (take|buy|eat) * diarrhea *`,
        `* why * diarrhea_foods_not_allowed_bad_hydration * avoid * diarrhea *`,
        `* why * avoid * diarrhea_foods_not_allowed_bad_hydration * diarrhea *`,
        `* why * not * (take|buy|eat)* diarrhea_foods_not_allowed_bad_hydration * diarrhea *`,
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_produces_gas * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* why * diarrhea_foods_not_allowed_produces_gas * avoid * diarrhea *`,
        `* why * (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_produces_gas * diarrhea *`,
        `* why * avoid * diarrhea_foods_not_allowed_produces_gas * diarrhea *`,
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_contains_lactose * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* why * diarrhea_foods_not_allowed_contains_lactose * avoid * diarrhea *`,
        `* why * (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_contains_lactose * diarrhea *`,
        `* why * avoid * diarrhea_foods_not_allowed_contains_lactose * diarrhea *`,
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_contains_fructose * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* why * diarrhea_foods_not_allowed_contains_fructose * avoid * diarrhea *`,
        `* why * (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_contains_fructose * diarrhea *`,
        `* why * avoid * diarrhea_foods_not_allowed_contains_fructose * diarrhea *`,
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_irritate_stomach * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* why * diarrhea_foods_not_allowed_irritate_stomach * avoid * diarrhea *`,
        `* why * (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_irritate_stomach * diarrhea *`,
        `* why * avoid * diarrhea_foods_not_allowed_irritate_stomach * diarrhea *`,
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_oily * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* why * diarrhea_foods_not_allowed_oily * avoid * diarrhea *`,
        `* why * (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_oily * diarrhea *`,
        `* why * avoid * diarrhea_foods_not_allowed_oily * diarrhea *`,
    ...
    encodeMemory([
        `* (which|what) * foods * avoid * diarrhea *`,
        `* (which|what) * foods * not * eaten * diarrhea *`,
        `* (which|what) * foods * not * taken * diarrhea *`,
