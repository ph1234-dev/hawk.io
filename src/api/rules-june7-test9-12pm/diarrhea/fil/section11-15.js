...
let section11 = [
    ...
    encodeMemory([
        `* dose * bismuth subsalicylate *`,
        `* hakbang * bismuth subsalicylate *`,
        `* (kainin|gamitin|inumin) * bismuth subsalicylate *`,
        `* bismuth subsalicylate * (gamitin|kainin|inumin) *`,
...
let section14 = [
    encodeMemory([
        `* (sino|saan) * tanong * (senyales|sintomas) * diarrhea *`,
        `* (senyales|sintomas) * diarrhea * (sino|saan) * tanong *`,
