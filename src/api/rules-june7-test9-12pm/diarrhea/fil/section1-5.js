...
let section4 = [
    ...
    encodeMemory([
        ...
        `Ano ang epekto ng allergy sa pagkain sa katawan na nagdudulot ng diarrhea ?`,
        `Ano ang koneksyon ng pagkakaroon ng allergy sa pagkain sa pagkakaroon ng diarrhea ?`,
        `Bakit dapat iwasan ang pagkain ng mga pagkain na mayroon kang allergy para maiwasan ang diarrhea ?`,
        `Bakit hindi maganda ang sobrang pagkain ng mga pagkain na mayroon kang allergy para sa kalusugan ng tiyan?`,
        `Bakit nakakapagdulot ng diarrhea  ang allergy sa pagkain?`,
        ...
        `Ang mga food allergy ay maaaring mag-trigger ng pagtatae bilang resulta ng immune response ng katawan sa isang allergen. Kapag may nakitang allergen, ang immune system ay naglalabas ng histamine at iba pang mga kemikal na maaaring magdulot ng pamamaga at pangangati sa bituka. 
    ...
    encodeMemory([
        ...
        `Ano-ano ang mga bakterya o virus na maaring magdulot ng diarrhea ?`,
        `Mga pagkain o inumin na maaaring magdulot ng diarrhea .`,
        `Mga posibleng dahilan ng panandaliang pagkakaroon ng diarrhea .`,
    ], [
        `
...
let section5 = [
    encodeMemory([
        ...
        `Ano ang ibang uri ng pagkain o inumin na nakatutulong sa pagpapa-hydrate sa may diarrhea ?`,
    ...
    encodeMemory([
        ...
        `Saan pwede magpatingin kung may lagnat na kasabay ng diarrhea ?`,
    ], [
    ...
    encodeMemory([
        ...
        `Mayroon bang mga pagkain o inumin na makakatulong sa pagpapagaling ng diarrhea ?`,
        `Paano gamutin ang diarrhea  sa bahay?`,
        `Paano malalaman kung anong uri ng gamot ang dapat gamitin para sa diarrhea ?`,
