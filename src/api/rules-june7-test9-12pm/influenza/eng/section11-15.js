...
let section11 = [
    ...
    encodeMemory([
        ...
        `tell or give me the list of generic antihistamine`,
    ],[
    ...
    encodeMemory([
        ...
        `tell or give me the list of branded antihistamine`,
    ],[
    ...
    encodeMemory([
        `* (take|use|dosing|direction) * antihistamine *`,
        `* antihistamine * (take|use|dosing|direction) *`,
        ...
        `tell me about how to take or eat antihistamines`,
    ...
    encodeMemory([
        ...
        `tell me why should a person avoid taking or eating antihistamines`,
        `tell me why is it necessary to not take or avoid having antihistamine`,
    ...
    encodeMemory([
        ...
        `give me the list of side effects of taking or eating antihistamines`,
    ...
    encodeMemory([
        ...
        `tell me how to you take, eat or use analgesics`,
    ...
    encodeMemory([
        ...
        `explain how analgesics work or treats illness`
    ],[
    ...
    encodeMemory([
        ...
        `explain why a person should not take or avoid analgesics`,
    ...
    encodeMemory([
        ...
        `show me the list of potential effects or complications when taking analgesics`
    ],[
    ...
    encodeMemory([
        ...
        `tell or give me tips or advices when taking analgesics`
    ],[
    ...
    encodeMemory([
        ...
        `tell or give me the list of alternatives for analgesics`,
    ...
    encodeMemory([
        ...
        `I'm looking for a list of non-brand-name anti-inflammatory drugs  or nsaids`,
        `I'm trying to find a list of non-branded NSAIDs.`,
    ...
    encodeMemory([
        ...
        `tell me how to eat or take nsaids`,
    ...
    encodeMemory([
        ...
        `tell or explain to me why nsaids can be harmful`,
    ],[
    ...
    encodeMemory([
        ...
        `tell or give me tips or advices when taking nsaids`
    ],[
    ...
    encodeMemory([
        ...
        `tell me or give me the list of different forms of nsaids`
    ],[
    ...
    encodeMemory([
        ...
        `tell or give me a list of alternative to nsaids`,
        `tell or show me the list of alternative or natural or herbal remedies aside from nsaids`
    ],[
    ...
    encodeMemory([
        ...
        `tell me or explain why decongestants should be avoided`
    ],[
    ...
    encodeMemory([
        ...
        `tell or show me the list of side effects of decongestants`
    ],[
    ...
    encodeMemory([
        ...
        `tell me advice or tips in taking or using decongestantss`
    ],[
    ...
    encodeMemory([
        ...
        `tell me about the existing alternatives or natural remedies to decongestants`
    ],[
    ...
    encodeMemory([
        `* (dosing|take|use|direction) * expectorant*`,
        ...
        `tell me what is the proper way of taking or using expectorants`
    ],[
    ...
    encodeMemory([
        ...
        `tell or show me the list of side effects of expectorants`
    ],[
    ...
    encodeMemory([
        ...
        `tell me about how to antitussives work or treat coughs`
    ],[
    ...
    encodeMemory([
        ...
        `explain why should i avoid taking or eating antitussivs`
    ],[
        `This medication is not safe for children under the age of 4 years.`
    ],7),
    encodeMemory([
        `* side effect * antitussive *`,
    ...
    encodeMemory([
        ...
        `tell or give me advice on how to take antitussives`
    ],[
    ...
    encodeMemory([
        `* (take|use|dosing|direction) * lozenge *`,
    ...
    encodeMemory([
        ...
        `tell me how lozenges work or treat sore throat`
    ],[
    ...
    encodeMemory([
        ...
        `tell why a person should not take or should avoid having lozenges`,
    ...
    encodeMemory([
        ...
        `tell or give an advice or tip in how to take lozenges`
    ],[
    ...
    encodeMemory([
        ...
        `tell or give the list of different forms of lozenges`
    ],[
...
let section14 = [
    ...
    encodeMemory([
        `* who * ask * (sign|symptom) * influenza *`,
        `* where * ask * (sign|symptom) * influenza *`,
        ...
        `tell me where can i ask abou the signs and symptoms of influenza`
    ],[
    ...
    encodeMemory([
        `* where * treat * (sign|symptom) * influenza *`,
