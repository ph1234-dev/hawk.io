...
let section11 = [
    ...
    encodeMemory([
        `* ano * branded * antihistamine * trangkaso *`,
    ...
    encodeMemory([
        `* ano * dose * antihistamine *`,
        `* ano * hakbang * antihistamine *`,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas ) * antihistamine *`,
    ...
    encodeMemory([
        `* (paano|ilan|ano) * (dose|hakbang) * analgesics *`,
    ...
    encodeMemory([
        ...
        `* paano * (tulong|gamot|buti|galing) * analgesics *`,
        `* paano * analgesics * (tulong|gamot|buti|galing) *`,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas) * analgesics *`,
    ...
    encodeMemory([
        `* (paano|ano) * (dose|hakbang) * nsaid*`,
        `* paano * (kainin|gamitin|inumin) * nsaid*`,
        `* paano * nsaid* (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* (bakit|paano) * nsaid * (tulong|gamot|buti|galing) *`,
        `* paano * gana * nsaid*`,
        `* paano * nsaid* gana * `,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas ) * nsaid*`,
    ...
    encodeMemory([
        `* ano * dose * decongestant *`,
        `* ano * hakbang * decongestant *`,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas) * decongestant *`,
    ...
    encodeMemory([
        `* ano * dose * expectorant*`,
        `* ano * hakbang * expectorant*`,
    ...
    encodeMemory([
        `* paano * gana * expectorant* `,
        `* paano * expectorant* gana * `,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas) * expectorant*`,
    ...
    encodeMemory([
        `* (paano|ano) * (dose|hakbang) * antitussive  *`,
        `* paano * (kainin|gamitin|inumin) * antitussive  *`,
    ...
    encodeMemory([
        ...
        `* paano * antitussive * gana * `,
        `* paano * gana * antitussive  *`,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas) * antitussive *`,
    ...
    encodeMemory([
        `* (paano|ano) * (dose|hakbang) * lozenge*`,
        `* paano * (kainin|gamitin|inumin) * lozenge*`,
        `* paano * lozenge* (gamitin|kainin|inumin) *`,
    ...
    encodeMemory([
        `* kailan * ( (huwag|hindi) * (kain|inom|gamit) | iwas ) * lozenge*`,
...
let section12 = [
    ...
    encodeMemory([
        ...
        `May mga kaibahan ba ang trangkaso o influenza type C sa ibang uri ng trangkaso?`, 
    ], [
...
let section13 = [
    encodeMemory([
        ...
        `Ano ang mga delikadong maaring lumabas kung hindi maaagapan ang trangkaso o influenza?`,  
