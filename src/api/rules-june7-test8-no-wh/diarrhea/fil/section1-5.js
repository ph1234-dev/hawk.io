...
let section4 = [
    ...
    encodeMemory([
        ...
        `Ano ang mga parasitic infection na maaaring magdulot ng diarrhea o pagtatae?`,
        `Bakit importante ang proper hygiene para maiwasan ang pagkakaroon ng parasitic infection?`,
        `Bakit kailangan ng pagpapatingin sa doktor kapag nagkaroon ng parasitic infection `,
    ...
    encodeMemory([
        ...
        `Ano ang mga viral infection na nagdudulot ng diarrhea o pagtatae?`,
...
let section5 = [
    encodeMemory([
        ...
        `Bakit importante ang hydration o pag-iinom ng maraming tubig  para sa may diarrhea o pagtatae?`,
        ...
        `Paano makakatulong ang pagpapa-hydrate sa pagbabawas ng diarrhea o pagtatae?`,
    ...
    encodeMemory([
        ...
        `Bakit dapat mag-inom o uminom ng zinc ang may diarrhea o pagtatae?`,
        `Bakit epektibo ang pag-inom ng zinc sa pagpapagaling ng diarrhea o pagtatae?`,  
        `Bakit importante ang pag-iinom ng zinc sa may diarrhea o pagtatae?`,
        `Bakit importante ang zinc para sa may diarrhea o pagtatae?`,
        `Bakit isang epektibong gamot ang zinc para sa may diarrhea o pagtatae?`,  
        `Bakit nakakatulong ang pag-iinom ng zinc sa may diarrhea o pagtatae?`,
        `Bakit o paano nakakatulong ang zinc sa pagbabawas ng diarrhea o pagtatae?`,  
        `Bakit nakakatulong ang zinc sa pagpapagaling ng mayroong diarrhea o pagtatae?`,
        `Paano malalaman kung sapat na ang zinc para sa may diarrhea o pagtatae?`,
        `Paano nakakapagbigay ng benepisyo o nakakatulong ang zinc sa may diarrhea o pagtatae?`, 
        `Paano nakapagpapagaling ang zinc sa may diarrhea o pagtatae?`,  
        `Paano nakatutulong ang pag-inom ng zinc sa may diarrhea o pagtatae?`,
    ], [
    ...
    encodeMemory([
        ...
        `Bakit dapat pag-iinom o pagkain ng masustansya ang may diarrhea o pagtatae?`,
        `Bakit hindi sapat ang kumain ng kahit ano lamang sa panahon ng pagkakaroon ng diarrhea o pagtatae?`,
        `Bakit importante ang pag-iinom o pagkain ng masustansya pag sa may diarrhea o pagtatae?`,
        `Bakit importante na kumain ng masustansya habang mayroong diarrhea o pagtatae?`,
        `Bakit importante pag-iinom o pagkain ng masustansya  para sa may diarrhea o pagtatae?`,
        `Bakit mahalagang kumain ng mga pagkain na mayaman sa sustansiya para sa mayroong diarrhea o pagtatae?`,
        `Bakit nakakatulong ang pag-iinom o pagkain ng masustansya pag may diarrhea o pagtatae?`,
        `Paano makakatulong ang masustansyang pagkain sa paggaling ng diarrhea o pagtatae?`,
        `Paano makakatulong ang pag-iinom o pagkain ng masustansya sa pagbabawas ng  diarrhea o pagtatae?`,
        `Paano makakatulong ang pagkain na mayaman sa sustansiya sa pagpapagaling ng diarrhea o pagtatae?`,
        `Paano malalaman kung sapat ang pag-iinom o pagkain ng masustansya pag may diarrhea o pagtatae?`,
        `Paano nakatutulong ang pag-iinom o pagkain ng masustansya sa may diarrhea o pagtatae?`,
    ...
    encodeMemory([
        `* saan * bili * (zinc|bismuth|antimotility) oral rehydration (solutions?|salts?) * `,
        `* saan * (zinc|bismuth|antimotility) oral rehydration (solutions?|salts?) * bili * `,
    ...
    encodeMemory([
        `* (paano|ano) * (tulong|gamot|buti|galing|gawin)   * diarrhea * `,
        `* (tulong|gamot|buti|galing|gawin) * diarrhea * (paano|ano) * `,
        `* diarrhea * (tulong|gamot|buti|galing|gawin) * (paano|ano) * `,
        ...
        `
        Ang paggamot sa pagtatae ay depende sa dahilan. Para sa mga hindi malalang kaso, maaaring makatulong ang mga over the counter na mga gamot tulad ng loperamide o bismuth subsicylate.Ngunit, huwag kang gumamit nito kung ikaw ay nilalagnat o nagdudugo ang iyong pagttae. 
