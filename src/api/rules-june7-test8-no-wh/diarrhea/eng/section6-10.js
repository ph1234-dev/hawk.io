...
let section8 = [
    ...
    encodeMemory([
        `* why * diarrhea_foods_not_allowed_bad_hydration * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* why * (not (take|buy|eat)|avoid) * diarrhea_foods_not_allowed_bad_hydration * diarrhea *`,
    ...
    encodeMemory([
        `* (which|what) * foods * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* foods * (not (take|buy|eat)|avoid) * diarrhea *`,
        `* (not (take|buy|eat)|avoid) * foods * diarrhea *`,
        `* diarrhea * (not (take|buy|eat)|avoid) * foods *`,
