...
let section5 = [
    ...
    encodeMemory([
        ...
        `How does a balanced diet aid in digestion and reduce diarrhea?`,
    ...
    encodeMemory([
        ...
        `Under what circumstances should I see or consult  a doctor for my diarrhea?`,
        ...
        `When should I be concerned enough to see a doctor or consult for my diarrhea?`,
    ...
    encodeMemory([
        ...
        `how should i treat or make myself feel better when having diarrhea`,
        `how does someone treat or make themselves feel better when experiencing diarrhea`
    ],[
        `
    ...
    encodeMemory([
        ...
        `how do you or someone treat diarrhea with fever`,
