...
data.push(
    encodeMemory([
        `* (treat|reduce|control|TAKE) * (vomit|vomiting) *`,
...
data.push(
    ...
    encodeMemory([
        `* (treat|reduce|control|TAKE) * (nauseouss|nausea) *`,
...
data.push(
    // 
    encodeMemory([
        `* (treat|reduce|control) * (chills|fever) *`,
...
data.push(
    ...
    encodeMemory([
        `* (treat|reduce|control) * (stuff|clog) * nose *`,
...
data.push(
    encodeMemory([
        ...
        'i sore throat please tell me what to',
...
data.push(
    encodeMemory([
        ...
        'i  body stiffness please tell me what to',
